...
*Generated: 2026-01-19 19:48:14*

## Summary

| Metric | Value |
|--------|-------|
| methods_discovered | 1041 |
| scripts_available | 32 |
| metrics_collected | 3 |
...
```json
{
  "report": {
    ...
    "generated": "2026-01-19T19:48:14.520596",
    "version": "1.0"
  },
  "discovery": {
    "methods": [
      ...
      {
        "name": "create_default_ged_calculator",
        "module": "insightspike.algorithms",
        "type": "function",
        "signature": "(**kwargs) -> 'GraphEditDistance'",
        "docstring": "Create a GED calculator with recommended default settings.",
        "full_name": "insightspike.algorithms.create_default_ged_calculator",
        "tags": []
      },
      {
        "name": "create_default_ig_calculator",
        "module": "insightspike.algorithms",
        "type": "function",
        "signature": "(**kwargs) -> 'InformationGain'",
        "docstring": "Create an IG calculator with recommended default settings.",
        "full_name": "insightspike.algorithms.create_default_ig_calculator",
        "tags": []
      },
      {
        ...
        "type": "function",
        "signature": "() -> 'dict'",
        "docstring": "Get comprehensive information about available algorithms.",
        "full_name": "insightspike.algorithms.get_algorithm_info",
        "tags": []
      },
      {
        "name": "entropy_ig",
        "module": "insightspike.algorithms.core",
        "type": "function",
        "signature": "(graph: 'nx.Graph', features_before: 'np.ndarray', features_after: 'np.ndarray', *, smoothing: 'float' = 1e-10, min_nodes: 'int' = 2, epsilon: 'float' = 0.001, norm_strategy: 'str' = 'before', extra_vectors: 'Optional[Sequence[Sequence[float]]]' = None, fixed_den: 'Optional[float]' = None, k_star: 'Optional[int]' = None, min_candidates: 'int' = 2, delta_mode: 'str' = 'after_before') -> 'Dict[str, float]'",
        "docstring": "Compute IG as reduction in mean local entropy, normalised by log(candidate_count).",
        "full_name": "insightspike.algorithms.core.entropy_ig",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.core",
        "type": "function",
        "signature": "(g: 'nx.Graph') -> 'float'",
        "docstring": "",
        "full_name": "insightspike.algorithms.core.graph_efficiency",
        "tags": []
      },
      {
        "name": "local_entropies",
        "module": "insightspike.algorithms.core",
        "type": "function",
        "signature": "(graph: 'nx.Graph', features: 'np.ndarray', smoothing: 'float' = 1e-10) -> 'np.ndarray'",
        "docstring": "",
        "full_name": "insightspike.algorithms.core.local_entropies",
        "tags": []
      },
      {
        "name": "normalized_ged",
        "module": "insightspike.algorithms.core",
        "type": "function",
        "signature": "(g1: 'nx.Graph', g2: 'nx.Graph', *, node_cost: 'float' = 1.0, edge_cost: 'float' = 1.0, normalization: 'str' = 'sum', efficiency_weight: 'float' = 0.3, enable_spectral: 'bool' = False, spectral_weight: 'float' = 0.3, norm_override: 'float | None' = None) -> 'Dict[str, float]'",
        "docstring": "Compute normalized GED and structural improvement.",
        "full_name": "insightspike.algorithms.core.normalized_ged",
        "tags": []
      },
      {
        "name": "spectral_score",
        ...
        "signature": "(g: 'nx.Graph') -> 'float'",
        "docstring": "",
        "full_name": "insightspike.algorithms.core.spectral_score",
        "tags": []
      },
      {
        "name": "entropy_ig",
        "module": "insightspike.algorithms.core.metrics",
        "type": "function",
        "signature": "(graph: 'nx.Graph', features_before: 'np.ndarray', features_after: 'np.ndarray', *, smoothing: 'float' = 1e-10, min_nodes: 'int' = 2, epsilon: 'float' = 0.001, norm_strategy: 'str' = 'before', extra_vectors: 'Optional[Sequence[Sequence[float]]]' = None, fixed_den: 'Optional[float]' = None, k_star: 'Optional[int]' = None, min_candidates: 'int' = 2, delta_mode: 'str' = 'after_before') -> 'Dict[str, float]'",
        "docstring": "Compute IG as reduction in mean local entropy, normalised by log(candidate_count).",
        "full_name": "insightspike.algorithms.core.metrics.entropy_ig",
        "tags": []
      },
      {
        "name": "graph_efficiency",
        ...
        "signature": "(g: 'nx.Graph') -> 'float'",
        "docstring": "",
        "full_name": "insightspike.algorithms.core.metrics.graph_efficiency",
        "tags": []
      },
      {
        "name": "local_entropies",
        ...
        "signature": "(graph: 'nx.Graph', features: 'np.ndarray', smoothing: 'float' = 1e-10) -> 'np.ndarray'",
        "docstring": "",
        "full_name": "insightspike.algorithms.core.metrics.local_entropies",
        "tags": []
      },
      {
        "name": "normalized_ged",
        ...
        "signature": "(g1: 'nx.Graph', g2: 'nx.Graph', *, node_cost: 'float' = 1.0, edge_cost: 'float' = 1.0, normalization: 'str' = 'sum', efficiency_weight: 'float' = 0.3, enable_spectral: 'bool' = False, spectral_weight: 'float' = 0.3, norm_override: 'float | None' = None) -> 'Dict[str, float]'",
        "docstring": "Compute normalized GED and structural improvement.",
        "full_name": "insightspike.algorithms.core.metrics.normalized_ged",
        "tags": []
      },
      {
        "name": "spectral_score",
        ...
        "signature": "(g: 'nx.Graph') -> 'float'",
        "docstring": "",
        "full_name": "insightspike.algorithms.core.metrics.spectral_score",
        "tags": []
      },
      {
        "name": "ContentStructureSeparation",
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "class",
        "signature": "()",
        "docstring": "Separates content and structural aspects of data for entropy calculation.",
        "full_name": "insightspike.algorithms.entropy_calculator.ContentStructureSeparation",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "class",
        "signature": "(content_method: Union[str, insightspike.algorithms.information_gain.EntropyMethod] = <EntropyMethod.CLUSTERING: 'clustering'>, structure_method: str = 'combined', content_weight: float = 0.6, structure_weight: float = 0.4)",
        "docstring": "Unified entropy calculator with proper content/structure separation.",
        "full_name": "insightspike.algorithms.entropy_calculator.EntropyCalculator",
        "tags": []
      },
      {
        "name": "EntropyMethod",
        ...
        "type": "class",
        "signature": "(*values)",
        "docstring": "Methods for calculating entropy.",
        "full_name": "insightspike.algorithms.entropy_calculator.EntropyMethod",
        "tags": []
      },
      {
        "name": "EntropyResult",
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "class",
        "signature": "(content_entropy: float, structural_entropy: float, combined_entropy: float, content_weight: float, structure_weight: float, method_used: str) -> None",
        "docstring": "Result of entropy calculation with content/structure separation.",
        "full_name": "insightspike.algorithms.entropy_calculator.EntropyResult",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "class",
        "signature": "(method: Union[str, insightspike.algorithms.information_gain.EntropyMethod] = <EntropyMethod.CLUSTERING: 'clustering'>, k_clusters: int = 8, min_samples: int = 2, random_state: int = 42)",
        "docstring": "Information Gain calculator for measuring learning progress.",
        "full_name": "insightspike.algorithms.entropy_calculator.InformationGain",
        "tags": []
      },
      {
        "name": "calc_structural_entropy",
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "function",
        "signature": "(graph: Any, weights: Optional[Dict[str, float]] = None) -> Dict[str, float]",
        "docstring": "Calculate multiple structural entropy measures.",
        "full_name": "insightspike.algorithms.entropy_calculator.calc_structural_entropy",
        "tags": []
      },
      {
        "name": "clustering_coefficient_entropy",
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "function",
        "signature": "(graph: Any) -> float",
        "docstring": "Calculate entropy based on clustering coefficient distribution.",
        "full_name": "insightspike.algorithms.entropy_calculator.clustering_coefficient_entropy",
        "tags": []
      },
      {
        "name": "degree_distribution_entropy",
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "function",
        "signature": "(graph: Any) -> float",
        "docstring": "Calculate entropy of the degree distribution.",
        "full_name": "insightspike.algorithms.entropy_calculator.degree_distribution_entropy",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.entropy_calculator",
        "type": "function",
        "signature": "(graph: Any, normalized: bool = True) -> float",
        "docstring": "Calculate Von Neumann entropy of the graph.",
        "full_name": "insightspike.algorithms.entropy_calculator.von_neumann_entropy",
        "tags": []
      },
      {
        "name": "GateDecision",
        "module": "insightspike.algorithms.gating",
        "type": "class",
        "signature": "(g0: 'float', gmin: 'float', ag: 'bool', dg: 'bool', b_value: 'float') -> None",
        "docstring": "GateDecision(g0: 'float', gmin: 'float', ag: 'bool', dg: 'bool', b_value: 'float')",
        "full_name": "insightspike.algorithms.gating.GateDecision",
        "tags": []
      },
      {
        "name": "decide_gates",
        "module": "insightspike.algorithms.gating",
        "type": "function",
        "signature": "(g0: 'float', gmin: 'float', theta_ag: 'float', theta_dg: 'float') -> 'GateDecision'",
        "docstring": "",
        "full_name": "insightspike.algorithms.gating.decide_gates",
        "tags": []
      },
      {
        "name": "create_csv_writer",
        "module": "insightspike.algorithms.gedig.ab_writer_helper",
        "type": "function",
        "signature": "(path: 'str | None' = None) -> 'Tuple[csv.writer, IO[str]]'",
        "docstring": "Create a CSV writer for A/B logs.",
        "full_name": "insightspike.algorithms.gedig.ab_writer_helper.create_csv_writer",
        "tags": []
      },
      {
        "name": "TwoThresholdCandidateSelector",
        "module": "insightspike.algorithms.gedig.selector",
        "type": "class",
        ...
        "full_name": "insightspike.algorithms.gedig.selector.TwoThresholdCandidateSelector",
        "tags": []
      },
      {
        "name": "TwoThresholdSelection",
        "module": "insightspike.algorithms.gedig.selector",
        "type": "class",
        "signature": "(candidates: 'List[Dict[str, Any]]', links: 'List[Dict[str, Any]]', forced_links: 'List[Dict[str, Any]]', k_star: 'int', theta_cand: 'float', theta_link: 'float', k_cap: 'int', top_m: 'Optional[int]' = None) -> None",
        "docstring": "Result container for two-threshold candidate selection.",
        "full_name": "insightspike.algorithms.gedig.selector.TwoThresholdSelection",
        "tags": []
      },
      {
        "name": "compute_gedig",
        "module": "insightspike.algorithms.gedig.selector",
        "type": "function",
        "signature": "(G_prev: 'Any', G_curr: 'Any', *, mode: 'Optional[str]' = None, variant: 'Optional[str]' = None) -> 'Dict[str, Any]'",
        "docstring": "Canonical geDIG entry.",
        "full_name": "insightspike.algorithms.gedig.selector.compute_gedig",
        "tags": []
      },
      {
        "name": "GeDIGABLogger",
        "module": "insightspike.algorithms.gedig_ab_logger",
        "type": "class",
        "signature": "(window: 'int' = 100, threshold: 'float' = 0.85, min_pairs: 'int' = 30, flush_every: 'int' = 50) -> 'None'",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_ab_logger.GeDIGABLogger",
        "tags": []
      },
      {
        "name": "GeDIGResult",
        "module": "insightspike.algorithms.gedig_ab_logger",
        "type": "class",
        "signature": "(mode: 'str', gedig: 'float', ged: 'Optional[float]', ig: 'Optional[float]') -> None",
        "docstring": "GeDIGResult(mode: 'str', gedig: 'float', ged: 'Optional[float]', ig: 'Optional[float]')",
        "full_name": "insightspike.algorithms.gedig_ab_logger.GeDIGResult",
        "tags": []
      },
      {
        "name": "DivergenceStats",
        "module": "insightspike.algorithms.gedig_analysis",
        "type": "class",
        "signature": "(count: 'int', mean_delta: 'float', max_delta: 'float', mean_legacy: 'float', mean_ref: 'float', pct_over_threshold: 'float', threshold: 'float') -> None",
        "docstring": "DivergenceStats(count: 'int', mean_delta: 'float', max_delta: 'float', mean_legacy: 'float', mean_ref: 'float', pct_over_threshold: 'float', threshold: 'float')",
        "full_name": "insightspike.algorithms.gedig_analysis.DivergenceStats",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.gedig_analysis",
        "type": "function",
        "signature": "(csv_path: 'str', threshold: 'float' = 0.3) -> 'DivergenceStats'",
        "docstring": "Analyze a divergence CSV produced by dual_evaluate.",
        "full_name": "insightspike.algorithms.gedig_analysis.analyze_divergence",
        "tags": []
      },
      {
        "name": "GeDIGCalculator",
        "module": "insightspike.algorithms.gedig_calculator",
        "type": "class",
        "signature": "(config=None)",
        "docstring": "Unified geDIG calculator with configuration-based behavior.",
        "full_name": "insightspike.algorithms.gedig_calculator.GeDIGCalculator",
        "tags": []
      },
      {
        "name": "GeDIGCore",
        "module": "insightspike.algorithms.gedig_calculator",
        "type": "class",
        "signature": "(node_cost: 'float' = 1.0, edge_cost: 'float' = 1.0, normalization: 'str' = 'sum', efficiency_weight: 'float' = 0.3, min_nodes: 'int' = 2, smoothing: 'float' = 1e-10, enable_multihop: 'bool' = False, max_hops: 'int' = 3, decay_factor: 'float' = 0.7, adaptive_hops: 'bool' = True, spike_threshold: 'float' = -0.5, enable_spectral: 'bool' = False, spectral_weight: 'float' = 0.3, lambda_weight: 'float' = 1.0, ig_mode: 'str' = 'raw', ig_norm_strategy: 'str' = 'before', ig_delta_mode: 'str' = 'after_before', entropy_tau: 'float' = 1.0, mu: 'float' = 0.5, warmup_steps: 'int' = 10, use_refactored_reward: 'bool' = True, use_legacy_formula: 'bool' = False, spike_detection_mode: 'str | SpikeDetectionMode' = 'and', tau_s: 'float' = 0.15, tau_i: 'float' = 0.25, use_multihop_sp_gain: 'bool' = True, sp_norm_mode: 'str' = 'relative', sp_beta: 'float' = 0.2, use_local_normalization: 'bool' = False, local_norm_mode: 'str' = 'layer1', enable_ged_min_diag: 'bool' = False, sp_node_cap: 'int' = 200, sp_pair_samples: 'int' = 400, sp_use_sampling: 'bool' = True, feature_weights: 'Optional[Sequence[float]]' = None, linkset_mode: 'bool' = False, sp_scope_mode: 'str' = 'auto', sp_hop_expand: 'int' = 0, sp_eval_mode: 'str' = 'connected', ig_source_mode: 'str' = 'graph', ig_hop_apply: 'str' = 'all', ged_norm_scheme: 'str' = 'edges_after', structural_similarity_config: 'Optional[Dict[str, Any]]' = None) -> 'None'",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_calculator.GeDIGCore",
        "tags": []
      },
      {
        "name": "GeDIGResult",
        "module": "insightspike.algorithms.gedig_calculator",
        "type": "class",
        "signature": "(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0) -> None",
        "docstring": "GeDIGResult(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0)",
        "full_name": "insightspike.algorithms.gedig_calculator.GeDIGResult",
        "tags": []
      },
      {
        "name": "calculate_gedig",
        "module": "insightspike.algorithms.gedig_calculator",
        "type": "function",
        "signature": "(graph_before: Any, graph_after: Any, config: Optional[Dict[str, Any]] = None, **kwargs) -> float",
        "docstring": "Simple interface for geDIG calculation.",
        "full_name": "insightspike.algorithms.gedig_calculator.calculate_gedig",
        "tags": []
      },
      {
        "name": "GeDIGCore",
        "module": "insightspike.algorithms.gedig_core",
        "type": "class",
        "signature": "(node_cost: 'float' = 1.0, edge_cost: 'float' = 1.0, normalization: 'str' = 'sum', efficiency_weight: 'float' = 0.3, min_nodes: 'int' = 2, smoothing: 'float' = 1e-10, enable_multihop: 'bool' = False, max_hops: 'int' = 3, decay_factor: 'float' = 0.7, adaptive_hops: 'bool' = True, spike_threshold: 'float' = -0.5, enable_spectral: 'bool' = False, spectral_weight: 'float' = 0.3, lambda_weight: 'float' = 1.0, ig_mode: 'str' = 'raw', ig_norm_strategy: 'str' = 'before', ig_delta_mode: 'str' = 'after_before', entropy_tau: 'float' = 1.0, mu: 'float' = 0.5, warmup_steps: 'int' = 10, use_refactored_reward: 'bool' = True, use_legacy_formula: 'bool' = False, spike_detection_mode: 'str | SpikeDetectionMode' = 'and', tau_s: 'float' = 0.15, tau_i: 'float' = 0.25, use_multihop_sp_gain: 'bool' = True, sp_norm_mode: 'str' = 'relative', sp_beta: 'float' = 0.2, use_local_normalization: 'bool' = False, local_norm_mode: 'str' = 'layer1', enable_ged_min_diag: 'bool' = False, sp_node_cap: 'int' = 200, sp_pair_samples: 'int' = 400, sp_use_sampling: 'bool' = True, feature_weights: 'Optional[Sequence[float]]' = None, linkset_mode: 'bool' = False, sp_scope_mode: 'str' = 'auto', sp_hop_expand: 'int' = 0, sp_eval_mode: 'str' = 'connected', ig_source_mode: 'str' = 'graph', ig_hop_apply: 'str' = 'all', ged_norm_scheme: 'str' = 'edges_after', structural_similarity_config: 'Optional[Dict[str, Any]]' = None) -> 'None'",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_core.GeDIGCore",
        "tags": []
      },
      {
        "name": "GeDIGLogger",
        "module": "insightspike.algorithms.gedig_core",
        "type": "class",
        "signature": "(output_path: 'Any', max_lines: 'int' = 50000, max_bytes: 'int' = 52428800, compress_on_rotate: 'bool' = False)",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_core.GeDIGLogger",
        "tags": []
      },
      {
        "name": "GeDIGMonitor",
        "module": "insightspike.algorithms.gedig_core",
        "type": "class",
        "signature": "(window_size: 'int' = 200, target_fp_rate: 'float' = 0.1, adjust_factor: 'float' = 1.1, gt_si_threshold: 'float | None' = None, gt_igz_threshold: 'float | None' = None, gt_mode: 'str' = 'and')",
        "docstring": "Runtime monitoring for spike predictions.",
        "full_name": "insightspike.algorithms.gedig_core.GeDIGMonitor",
        "tags": []
      },
      {
        "name": "GeDIGPresets",
        ...
        "signature": "()",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_core.GeDIGPresets",
        "tags": []
      },
      {
        "name": "GeDIGResult",
        ...
        "signature": "(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0) -> None",
        "docstring": "GeDIGResult(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0)",
        "full_name": "insightspike.algorithms.gedig_core.GeDIGResult",
        "tags": []
      },
      {
        "name": "HopResult",
        "module": "insightspike.algorithms.gedig_core",
        "type": "class",
        "signature": "(hop: 'int', ged: 'float', ig: 'float', gedig: 'float', struct_cost: 'float', node_count: 'int', edge_count: 'int', sp: 'float' = 0.0, h_component: 'float' = 0.0, ged_raw: 'float' = 0.0, ged_den: 'float' = 1.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, ig_den: 'float' = 1.0, variance_reduction: 'float' = 0.0) -> None",
        "docstring": "HopResult(hop: 'int', ged: 'float', ig: 'float', gedig: 'float', struct_cost: 'float', node_count: 'int', edge_count: 'int', sp: 'float' = 0.0, h_component: 'float' = 0.0, ged_raw: 'float' = 0.0, ged_den: 'float' = 1.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, ig_den: 'float' = 1.0, variance_reduction: 'float' = 0.0)",
        "full_name": "insightspike.algorithms.gedig_core.HopResult",
        "tags": []
      },
      {
        "name": "LinksetMetrics",
        "module": "insightspike.algorithms.gedig_core",
        "type": "class",
        "signature": "(delta_ged_norm: 'float', delta_h_norm: 'float', delta_sp_rel: 'float', gedig_value: 'float', raw_ged: 'float', ged_norm_den: 'float', ig_norm_den: 'float', entropy_before: 'float', entropy_after: 'float', ig_delta: 'float', before_size: 'int', after_size: 'int', query_similarity: 'float', pos_w_before: 'int' = 0, pos_w_after: 'int' = 0, topw_before: 'list[float] | None' = None, topw_after: 'list[float] | None' = None) -> None",
        "docstring": "LinksetMetrics(delta_ged_norm: 'float', delta_h_norm: 'float', delta_sp_rel: 'float', gedig_value: 'float', raw_ged: 'float', ged_norm_den: 'float', ig_norm_den: 'float', entropy_before: 'float', entropy_after: 'float', ig_delta: 'float', before_size: 'int', after_size: 'int', query_similarity: 'float', pos_w_before: 'int' = 0, pos_w_after: 'int' = 0, topw_before: 'list[float] | None' = None, topw_after: 'list[float] | None' = None)",
        "full_name": "insightspike.algorithms.gedig_core.LinksetMetrics",
        "tags": []
      },
      {
        "name": "ProcessingMode",
        ...
        "full_name": "insightspike.algorithms.gedig_core.ProcessingMode",
        "tags": []
      },
      {
        "name": "SpikeDetectionMode",
        "module": "insightspike.algorithms.gedig_core",
        "type": "class",
        "signature": "(*values)",
        "docstring": "Create a collection of name/value pairs.",
        "full_name": "insightspike.algorithms.gedig_core.SpikeDetectionMode",
        "tags": []
      },
      {
        "name": "calculate_gedig",
        ...
        "type": "function",
        "signature": "(graph_before: 'Any', graph_after: 'Any', config: 'Optional[Dict[str, Any]]' = None, **kwargs) -> 'float'",
        "docstring": "Simple interface to calculate geDIG value.",
        "full_name": "insightspike.algorithms.gedig_core.calculate_gedig",
        "tags": []
      },
      {
        "name": "delta_ged",
        ...
        "docstring": "Calculate \u0394GED for backward compatibility.",
        "full_name": "insightspike.algorithms.gedig_core.delta_ged",
        "tags": []
      },
      {
        "name": "delta_ig",
        ...
        "type": "function",
        "signature": "(graph_before: 'Any', graph_after: 'Any', **kwargs) -> 'float'",
        "docstring": "Calculate \u0394IG for backward compatibility.",
        "full_name": "insightspike.algorithms.gedig_core.delta_ig",
        "tags": []
      },
      {
        "name": "detect_insight_spike",
        "module": "insightspike.algorithms.gedig_core",
        "type": "function",
        "signature": "(graph_before: 'Any', graph_after: 'Any', threshold: 'float' = -0.5, **kwargs) -> 'bool'",
        "docstring": "Check if the graph change represents an insight spike.",
        "full_name": "insightspike.algorithms.gedig_core.detect_insight_spike",
        "tags": []
      },
      {
        "name": "GeDIGCore",
        "module": "insightspike.algorithms.gedig_factory",
        "type": "class",
        "signature": "(node_cost: 'float' = 1.0, edge_cost: 'float' = 1.0, normalization: 'str' = 'sum', efficiency_weight: 'float' = 0.3, min_nodes: 'int' = 2, smoothing: 'float' = 1e-10, enable_multihop: 'bool' = False, max_hops: 'int' = 3, decay_factor: 'float' = 0.7, adaptive_hops: 'bool' = True, spike_threshold: 'float' = -0.5, enable_spectral: 'bool' = False, spectral_weight: 'float' = 0.3, lambda_weight: 'float' = 1.0, ig_mode: 'str' = 'raw', ig_norm_strategy: 'str' = 'before', ig_delta_mode: 'str' = 'after_before', entropy_tau: 'float' = 1.0, mu: 'float' = 0.5, warmup_steps: 'int' = 10, use_refactored_reward: 'bool' = True, use_legacy_formula: 'bool' = False, spike_detection_mode: 'str | SpikeDetectionMode' = 'and', tau_s: 'float' = 0.15, tau_i: 'float' = 0.25, use_multihop_sp_gain: 'bool' = True, sp_norm_mode: 'str' = 'relative', sp_beta: 'float' = 0.2, use_local_normalization: 'bool' = False, local_norm_mode: 'str' = 'layer1', enable_ged_min_diag: 'bool' = False, sp_node_cap: 'int' = 200, sp_pair_samples: 'int' = 400, sp_use_sampling: 'bool' = True, feature_weights: 'Optional[Sequence[float]]' = None, linkset_mode: 'bool' = False, sp_scope_mode: 'str' = 'auto', sp_hop_expand: 'int' = 0, sp_eval_mode: 'str' = 'connected', ig_source_mode: 'str' = 'graph', ig_hop_apply: 'str' = 'all', ged_norm_scheme: 'str' = 'edges_after', structural_similarity_config: 'Optional[Dict[str, Any]]' = None) -> 'None'",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_factory.GeDIGCore",
        "tags": []
      },
      {
        "name": "GeDIGFactory",
        ...
        "signature": "()",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_factory.GeDIGFactory",
        "tags": []
      },
      {
        "name": "dual_evaluate",
        "module": "insightspike.algorithms.gedig_factory",
        "type": "function",
        "signature": "(legacy_core: 'GeDIGCore', ref_core: 'GeDIGCore', *, g_prev: 'Any', g_now: 'Any', delta_threshold: 'float' = 0.3, divergence_logger: 'Optional[str]' = None) -> 'Tuple[Any, float]'",
        "docstring": "Run both cores and emit warning if divergence exceeds threshold.",
        "full_name": "insightspike.algorithms.gedig_factory.dual_evaluate",
        "tags": []
      },
      {
        "name": "PureGeDIGCalculator",
        "module": "insightspike.algorithms.gedig_pure",
        "type": "class",
        "signature": "(k: 'float' = 0.5, adaptive_k: 'bool' = False, k_min: 'float' = 0.3, k_max: 'float' = 0.7, decay: 'float' = 0.02)",
        "docstring": "Minimal calculator (GED\u5dee\u5206\u6b63\u898f\u5316, IG=entropy\u5897\u52a0, geDIG=ged - k*ig).",
        "full_name": "insightspike.algorithms.gedig_pure.PureGeDIGCalculator",
        "tags": []
      },
      {
        "name": "PureGeDIGResult",
        "module": "insightspike.algorithms.gedig_pure",
        "type": "class",
        "signature": "(gedig: 'float', ged: 'float', ig: 'float', k: 'float', nodes_before: 'int', nodes_after: 'int', edges_before: 'int', edges_after: 'int', entropy_before: 'float', entropy_after: 'float', metadata: 'Optional[Dict[str, Any]]' = None) -> None",
        "docstring": "PureGeDIGResult(gedig: 'float', ged: 'float', ig: 'float', k: 'float', nodes_before: 'int', nodes_after: 'int', edges_before: 'int', edges_after: 'int', entropy_before: 'float', entropy_after: 'float', metadata: 'Optional[Dict[str, Any]]' = None)",
        "full_name": "insightspike.algorithms.gedig_pure.PureGeDIGResult",
        "tags": []
      },
      {
        "name": "GEDCalculationUtils",
        "module": "insightspike.algorithms.gedig_utils",
        "type": "class",
        "signature": "()",
        "docstring": "Utilities for Graph Edit Distance calculations.",
        "full_name": "insightspike.algorithms.gedig_utils.GEDCalculationUtils",
        "tags": []
      },
      {
        "name": "GeDIGComputationUtils",
        "module": "insightspike.algorithms.gedig_utils",
        "type": "class",
        "signature": "()",
        "docstring": "High-level utilities for geDIG computations.",
        "full_name": "insightspike.algorithms.gedig_utils.GeDIGComputationUtils",
        "tags": []
      },
      {
        "name": "GraphValidationUtils",
        "module": "insightspike.algorithms.gedig_utils",
        "type": "class",
        "signature": "()",
        "docstring": "Utilities for graph validation and sanitization.",
        "full_name": "insightspike.algorithms.gedig_utils.GraphValidationUtils",
        "tags": []
      },
      {
        "name": "IGCalculationUtils",
        "module": "insightspike.algorithms.gedig_utils",
        "type": "class",
        "signature": "()",
        "docstring": "Utilities for Information Gain calculations.",
        "full_name": "insightspike.algorithms.gedig_utils.IGCalculationUtils",
        "tags": []
      },
      {
        "name": "GeDIGCore",
        "module": "insightspike.algorithms.gedig_wake_mode",
        "type": "class",
        "signature": "(node_cost: 'float' = 1.0, edge_cost: 'float' = 1.0, normalization: 'str' = 'sum', efficiency_weight: 'float' = 0.3, min_nodes: 'int' = 2, smoothing: 'float' = 1e-10, enable_multihop: 'bool' = False, max_hops: 'int' = 3, decay_factor: 'float' = 0.7, adaptive_hops: 'bool' = True, spike_threshold: 'float' = -0.5, enable_spectral: 'bool' = False, spectral_weight: 'float' = 0.3, lambda_weight: 'float' = 1.0, ig_mode: 'str' = 'raw', ig_norm_strategy: 'str' = 'before', ig_delta_mode: 'str' = 'after_before', entropy_tau: 'float' = 1.0, mu: 'float' = 0.5, warmup_steps: 'int' = 10, use_refactored_reward: 'bool' = True, use_legacy_formula: 'bool' = False, spike_detection_mode: 'str | SpikeDetectionMode' = 'and', tau_s: 'float' = 0.15, tau_i: 'float' = 0.25, use_multihop_sp_gain: 'bool' = True, sp_norm_mode: 'str' = 'relative', sp_beta: 'float' = 0.2, use_local_normalization: 'bool' = False, local_norm_mode: 'str' = 'layer1', enable_ged_min_diag: 'bool' = False, sp_node_cap: 'int' = 200, sp_pair_samples: 'int' = 400, sp_use_sampling: 'bool' = True, feature_weights: 'Optional[Sequence[float]]' = None, linkset_mode: 'bool' = False, sp_scope_mode: 'str' = 'auto', sp_hop_expand: 'int' = 0, sp_eval_mode: 'str' = 'connected', ig_source_mode: 'str' = 'graph', ig_hop_apply: 'str' = 'all', ged_norm_scheme: 'str' = 'edges_after', structural_similarity_config: 'Optional[Dict[str, Any]]' = None) -> 'None'",
        "docstring": "",
        "full_name": "insightspike.algorithms.gedig_wake_mode.GeDIGCore",
        "tags": []
      },
      {
        "name": "GeDIGResult",
        ...
        "signature": "(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0) -> None",
        "docstring": "GeDIGResult(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0)",
        "full_name": "insightspike.algorithms.gedig_wake_mode.GeDIGResult",
        "tags": []
      },
      {
        "name": "ProcessingMode",
        ...
        "type": "class",
        "signature": "(*values)",
        "docstring": "Processing modes for geDIG calculation.",
        "full_name": "insightspike.algorithms.gedig_wake_mode.ProcessingMode",
        "tags": []
      },
      {
        "name": "WakeModeGeDIG",
        ...
        "docstring": "Wake Mode geDIG calculator for efficient query processing.",
        "full_name": "insightspike.algorithms.gedig_wake_mode.WakeModeGeDIG",
        "tags": []
      },
      {
        "name": "WakeModeResult",
        "module": "insightspike.algorithms.gedig_wake_mode",
        "type": "class",
        "signature": "(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0, mode: str = 'wake', pattern_match_score: float = 0.0, convergence_score: float = 0.0, efficiency_score: float = 0.0, nearest_patterns: Optional[List[str]] = None) -> None",
        "docstring": "Extended result for Wake Mode processing.",
        "full_name": "insightspike.algorithms.gedig_wake_mode.WakeModeResult",
        "tags": []
      },
      {
        "name": "calculate_wake_mode_gedig",
        "module": "insightspike.algorithms.gedig_wake_mode",
        "type": "function",
        "signature": "(graph: networkx.classes.graph.Graph, focal_nodes: Set[str], query_context: Optional[Dict[str, Any]] = None, **kwargs) -> insightspike.algorithms.gedig_wake_mode.WakeModeResult",
        "docstring": "Calculate geDIG in Wake Mode.",
        "full_name": "insightspike.algorithms.gedig_wake_mode.calculate_wake_mode_gedig",
        "tags": []
      },
      {
        "name": "GeometricProbabilisticGraph",
        "module": "insightspike.algorithms.geometric_probabilistic_graph",
        "type": "class",
        "signature": "(embedding_dim: 'int' = 384, attention_heads: 'int' = 4, attention_hidden_dim: 'int' = 128, model_name: 'str' = 'all-MiniLM-L6-v2', use_gpu: 'bool' = False)",
        "docstring": "Unified representation integrating three spaces:",
        "full_name": "insightspike.algorithms.geometric_probabilistic_graph.GeometricProbabilisticGraph",
        "tags": []
      },
      {
        "name": "GraphAttentionProbability",
        "module": "insightspike.algorithms.geometric_probabilistic_graph",
        "type": "class",
        "signature": "(in_channels: 'int', out_channels: 'int', heads: 'int' = 4, dropout: 'float' = 0.1, concat: 'bool' = True)",
        "docstring": "Graph Attention layer that produces probability distributions.",
        "full_name": "insightspike.algorithms.geometric_probabilistic_graph.GraphAttentionProbability",
        "tags": []
      },
      {
        "name": "ThreeSpaceMetrics",
        "module": "insightspike.algorithms.geometric_probabilistic_graph",
        "type": "class",
        "signature": "(num_nodes: 'int', num_edges: 'int', graph_density: 'float', avg_degree: 'float', shannon_entropy: 'float', probability_mass: 'float', entropy_per_node: 'np.ndarray', avg_cosine_similarity: 'float', embedding_std: 'float', pairwise_distances: 'Optional[np.ndarray]' = None) -> None",
        "docstring": "Metrics capturing all three spaces",
        "full_name": "insightspike.algorithms.geometric_probabilistic_graph.ThreeSpaceMetrics",
        "tags": []
      },
      {
        "name": "calculate_three_space_entropy",
        "module": "insightspike.algorithms.geometric_probabilistic_graph",
        "type": "function",
        "signature": "(texts: 'List[str]', edges: 'Optional[List[Tuple[int, int]]]' = None, embedding_dim: 'int' = 384) -> 'float'",
        "docstring": "Convenience function: Calculate Shannon entropy from texts and graph structure.",
        "full_name": "insightspike.algorithms.geometric_probabilistic_graph.calculate_three_space_entropy",
        "tags": []
      },
      {
        "name": "calculate_three_space_information_gain",
        "module": "insightspike.algorithms.geometric_probabilistic_graph",
        "type": "function",
        "signature": "(texts_before: 'List[str]', texts_after: 'List[str]', edges_before: 'Optional[List[Tuple[int, int]]]' = None, edges_after: 'Optional[List[Tuple[int, int]]]' = None, embedding_dim: 'int' = 384) -> 'float'",
        "docstring": "Convenience function: Calculate information gain between two states.",
        "full_name": "insightspike.algorithms.geometric_probabilistic_graph.calculate_three_space_information_gain",
        "tags": []
      },
      {
        "name": "GEDResult",
        "module": "insightspike.algorithms.graph_edit_distance",
        "type": "class",
        "signature": "(ged_value: float, computation_time: float, optimization_level: insightspike.algorithms.graph_edit_distance.OptimizationLevel, graph1_size: int, graph2_size: int, timeout_occurred: bool = False, approximation_used: bool = False) -> None",
        "docstring": "Result of GED calculation with metadata.",
        "full_name": "insightspike.algorithms.graph_edit_distance.GEDResult",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.graph_edit_distance",
        "type": "class",
        "signature": "(node_cost: float = 1.0, edge_cost: float = 1.0, optimization_level: Union[str, insightspike.algorithms.graph_edit_distance.OptimizationLevel] = <OptimizationLevel.STANDARD: 'standard'>, timeout_seconds: float = 5.0, max_graph_size_exact: int = 50)",
        "docstring": "Graph Edit Distance calculator for PyTorch Geometric graphs.",
        "full_name": "insightspike.algorithms.graph_edit_distance.GraphEditDistance",
        "tags": []
      },
      {
        ...
        "type": "class",
        "signature": "(*values)",
        "docstring": "Optimization levels for GED calculation.",
        "full_name": "insightspike.algorithms.graph_edit_distance.OptimizationLevel",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.graph_edit_distance",
        "type": "function",
        "signature": "(graph_before: torch_geometric.data.data.Data, graph_after: torch_geometric.data.data.Data, reference_graph: Optional[torch_geometric.data.data.Data] = None, **kwargs) -> float",
        "docstring": "Compute \u0394GED for insight detection.",
        "full_name": "insightspike.algorithms.graph_edit_distance.compute_delta_ged",
        "tags": []
      },
      {
        "name": "compute_graph_edit_distance",
        "module": "insightspike.algorithms.graph_edit_distance",
        "type": "function",
        "signature": "(graph1: torch_geometric.data.data.Data, graph2: torch_geometric.data.data.Data, **kwargs) -> float",
        "docstring": "Compute Graph Edit Distance between two PyG graphs.",
        "full_name": "insightspike.algorithms.graph_edit_distance.compute_graph_edit_distance",
        "tags": []
      },
      {
        "name": "get_global_ged_calculator",
        "module": "insightspike.algorithms.graph_edit_distance",
        "type": "function",
        "signature": "() -> insightspike.algorithms.graph_edit_distance.GraphEditDistance",
        "docstring": "Get or create global GED calculator instance.",
        "full_name": "insightspike.algorithms.graph_edit_distance.get_global_ged_calculator",
        "tags": []
      },
      {
        "name": "reset_ged_state",
        "module": "insightspike.algorithms.graph_edit_distance",
        "type": "function",
        "signature": "()",
        "docstring": "Reset the global GED calculator state.",
        "full_name": "insightspike.algorithms.graph_edit_distance.reset_ged_state",
        "tags": []
      },
      {
        "name": "DynamicImportanceTracker",
        "module": "insightspike.algorithms.graph_importance",
        "type": "class",
        "signature": "(calculator: Optional[insightspike.algorithms.graph_importance.GraphImportanceCalculator] = None)",
        "docstring": "Track and update importance scores dynamically as the graph evolves.",
        "full_name": "insightspike.algorithms.graph_importance.DynamicImportanceTracker",
        "tags": []
      },
      {
        "name": "GraphImportanceCalculator",
        "module": "insightspike.algorithms.graph_importance",
        "type": "class",
        "signature": "(decay_factor: float = 0.1, alpha: float = 0.85, epsilon: float = 1e-06, max_iterations: int = 100)",
        "docstring": "Calculate node importance using various graph centrality measures.",
        "full_name": "insightspike.algorithms.graph_importance.GraphImportanceCalculator",
        "tags": []
      },
      {
        "name": "GraphStructureAnalyzer",
        "module": "insightspike.algorithms.graph_structure_analyzer",
        "type": "class",
        "signature": "()",
        "docstring": "Analyzes structural changes in graphs for insight detection.",
        "full_name": "insightspike.algorithms.graph_structure_analyzer.GraphStructureAnalyzer",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.graph_structure_analyzer",
        "type": "function",
        "signature": "(graph_before: Any, graph_after: Any) -> Dict[str, float]",
        "docstring": "Convenience function for structure analysis.",
        "full_name": "insightspike.algorithms.graph_structure_analyzer.analyze_graph_structure",
        "tags": []
      },
      {
        "name": "NormalizationMethod",
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "class",
        "signature": "(*values)",
        "docstring": "Available normalization methods",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.NormalizationMethod",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "function",
        "signature": "(before_vectors: numpy.ndarray, after_vectors: numpy.ndarray, method: insightspike.algorithms.improved_similarity_entropy.NormalizationMethod = <NormalizationMethod.SIGMOID: 'sigmoid'>, **kwargs) -> float",
        "docstring": "Calculate the change in entropy (\u0394H).",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.calculate_entropy_change",
        "tags": []
      },
      {
        ...
        "type": "function",
        "signature": "(before_vectors: numpy.ndarray, after_vectors: numpy.ndarray, method: insightspike.algorithms.improved_similarity_entropy.NormalizationMethod = <NormalizationMethod.SIGMOID: 'sigmoid'>, **kwargs) -> float",
        "docstring": "Calculate information gain (IG).",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.calculate_information_gain",
        "tags": []
      },
      {
        "name": "calculate_similarity_entropy",
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "function",
        "signature": "(vectors: numpy.ndarray, method: insightspike.algorithms.improved_similarity_entropy.NormalizationMethod = <NormalizationMethod.SIGMOID: 'sigmoid'>, **kwargs) -> float",
        "docstring": "Calculate entropy based on pairwise similarities with improved normalization.",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.calculate_similarity_entropy",
        "tags": []
      },
      {
        "name": "exponential_normalization",
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "function",
        "signature": "(similarity: float, alpha: float = 2.0) -> float",
        "docstring": "Exponential normalization emphasizing high similarities.",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.exponential_normalization",
        "tags": []
      },
      {
        "name": "linear_normalization",
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "function",
        "signature": "(similarity: float) -> float",
        "docstring": "Linear mapping from similarity to entropy.",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.linear_normalization",
        "tags": []
      },
      {
        "name": "piecewise_normalization",
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "function",
        "signature": "(similarity: float) -> float",
        "docstring": "Custom piecewise normalization with different sensitivity regions.",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.piecewise_normalization",
        "tags": []
      },
      {
        "name": "sigmoid_normalization",
        "module": "insightspike.algorithms.improved_similarity_entropy",
        "type": "function",
        "signature": "(similarity: float, steepness: float = 5.0) -> float",
        "docstring": "Sigmoid-based normalization for smoother transitions.",
        "full_name": "insightspike.algorithms.improved_similarity_entropy.sigmoid_normalization",
        "tags": []
      },
      {
        "name": "EntropyMethod",
        "module": "insightspike.algorithms.information_gain",
        "type": "class",
        "signature": "(*values)",
        "docstring": "Methods for calculating entropy.",
        "full_name": "insightspike.algorithms.information_gain.EntropyMethod",
        "tags": []
      },
      {
        "name": "IGResult",
        "module": "insightspike.algorithms.information_gain",
        "type": "class",
        "signature": "(ig_value: float, entropy_before: float, entropy_after: float, computation_time: float, method: insightspike.algorithms.information_gain.EntropyMethod, sample_count: int, feature_count: int, approximation_used: bool = False) -> None",
        "docstring": "Result of Information Gain calculation with metadata.",
        "full_name": "insightspike.algorithms.information_gain.IGResult",
        "tags": []
      },
      {
        "name": "ImprovedEntropyMethods",
        "module": "insightspike.algorithms.information_gain",
        "type": "class",
        "signature": "()",
        "docstring": "Advanced entropy calculation methods integrated from graph/metrics/entropy_ig.py.",
        "full_name": "insightspike.algorithms.information_gain.ImprovedEntropyMethods",
        "tags": []
      },
      {
        "name": "InformationGain",
        ...
        "signature": "(method: Union[str, insightspike.algorithms.information_gain.EntropyMethod] = <EntropyMethod.CLUSTERING: 'clustering'>, k_clusters: int = 8, min_samples: int = 2, random_state: int = 42)",
        "docstring": "Information Gain calculator for measuring learning progress.",
        "full_name": "insightspike.algorithms.information_gain.InformationGain",
        "tags": []
      },
      {
        "name": "calc_structural_entropy",
        ...
        "signature": "(graph: Any, weights: Optional[Dict[str, float]] = None) -> Dict[str, float]",
        "docstring": "Calculate multiple structural entropy measures.",
        "full_name": "insightspike.algorithms.information_gain.calc_structural_entropy",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.information_gain",
        "type": "function",
        "signature": "(state_before: Any, state_after: Any, method: str = 'clustering', **kwargs) -> float",
        "docstring": "Compute \u0394IG for insight detection.",
        "full_name": "insightspike.algorithms.information_gain.compute_delta_ig",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.information_gain",
        "type": "function",
        "signature": "(data_before: Any, data_after: Any, method: str = 'clustering', **kwargs) -> float",
        "docstring": "Compute Information Gain between two data states.",
        "full_name": "insightspike.algorithms.information_gain.compute_information_gain",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.information_gain",
        "type": "function",
        "signature": "(data: Any) -> float",
        "docstring": "Compute Shannon entropy for data.",
        "full_name": "insightspike.algorithms.information_gain.compute_shannon_entropy",
        "tags": []
      },
      {
        "name": "degree_distribution_entropy",
        ...
        "signature": "(graph: Any) -> float",
        "docstring": "Calculate entropy of the degree distribution.",
        "full_name": "insightspike.algorithms.information_gain.degree_distribution_entropy",
        "tags": []
      },
      {
        "name": "von_neumann_entropy",
        ...
        "signature": "(graph: Any, normalized: bool = True) -> float",
        "docstring": "Calculate Von Neumann entropy of the graph.",
        "full_name": "insightspike.algorithms.information_gain.von_neumann_entropy",
        "tags": []
      },
      {
        "name": "EditOperation",
        "module": "insightspike.algorithms.isomorphism_discovery",
        "type": "class",
        "signature": "(edit_type: insightspike.algorithms.isomorphism_discovery.EditType, source: Optional[str] = None, target: Optional[str] = None, params: Dict[str, Any] = <factory>) -> None",
        "docstring": "\u5358\u4e00\u306e\u7de8\u96c6\u64cd\u4f5c",
        "full_name": "insightspike.algorithms.isomorphism_discovery.EditOperation",
        "tags": []
      },
      {
        "name": "EditType",
        ...
        "signature": "(*values)",
        "docstring": "\u7de8\u96c6\u64cd\u4f5c\u306e\u7a2e\u985e",
        "full_name": "insightspike.algorithms.isomorphism_discovery.EditType",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.isomorphism_discovery",
        "type": "class",
        "signature": "(node_cost: float = 1.0, edge_cost: float = 1.0, relabel_cost: float = 0.5, use_semantic_similarity: bool = True, beam_width: int = 10, max_iterations: int = 1000)",
        "docstring": "\u540c\u578b\u767a\u898b\u30a2\u30eb\u30b4\u30ea\u30ba\u30e0",
        "full_name": "insightspike.algorithms.isomorphism_discovery.IsomorphismDiscovery",
        "tags": []
      },
      {
        "name": "PartialMapping",
        "module": "insightspike.algorithms.isomorphism_discovery",
        "type": "class",
        "signature": "(mapped: Dict[str, str], remaining_source: List[str], remaining_target: Set[str], score: float = inf) -> None",
        "docstring": "\u90e8\u5206\u7684\u306a\u30de\u30c3\u30d4\u30f3\u30b0\uff08\u63a2\u7d22\u4e2d\u306e\u72b6\u614b\uff09",
        "full_name": "insightspike.algorithms.isomorphism_discovery.PartialMapping",
        "tags": []
      },
      {
        "name": "Transform",
        "module": "insightspike.algorithms.isomorphism_discovery",
        "type": "class",
        "signature": "(node_mapping: Dict[str, str] = <factory>, edit_operations: List[insightspike.algorithms.isomorphism_discovery.EditOperation] = <factory>, cost: float = 0.0, metadata: Dict[str, Any] = <factory>) -> None",
        "docstring": "\u30b0\u30e9\u30d5\u5909\u63db\u3092\u8868\u3059\u30af\u30e9\u30b9",
        "full_name": "insightspike.algorithms.isomorphism_discovery.Transform",
        "tags": []
      },
      {
        ...
        "module": "insightspike.algorithms.isomorphism_discovery",
        "type": "function",
        "signature": "() -> Tuple[networkx.classes.graph.Graph, networkx.classes.graph.Graph, Dict[str, str]]",
        "docstring": "\u30c6\u30b9\u30c8\u7528\u306e\u30b0\u30e9\u30d5\u30da\u30a2\uff08\u65e2\u77e5\u306e\u5909\u63db\u4ed8\u304d\uff09\u3092\u4f5c\u6210",
        "full_name": "insightspike.algorithms.isomorphism_discovery.create_test_graphs",
        "tags": []
      },
      {
        "name": "discover_insight",
        "module": "insightspike.algorithms.isomorphism_discovery",
        "type": "function",
        "signature": "(source_graph: networkx.classes.graph.Graph, target_graph: networkx.classes.graph.Graph, **kwargs) -> insightspike.algorithms.isomorphism_discovery.Transform",
        "docstring": "2\u3064\u306e\u30b0\u30e9\u30d5\u9593\u306e\u300c\u9583\u304d\u300d\uff08\u6700\u5c0f\u5909\u63db\uff09\u3092\u767a\u898b\u3059\u308b",
        "full_name": "insightspike.algorithms.isomorphism_discovery.discover_insight",
        "tags": []
      },
      {
        "name": "build_linkset_info",
        "module": "insightspike.algorithms.linkset_adapter",
        "type": "function",
        "signature": "(*, s_link: 'Optional[Sequence[Dict[str, Any]]]' = None, candidate_pool: 'Optional[Sequence[Dict[str, Any]]]' = None, decision: 'Optional[Dict[str, Any]]' = None, query_vector: 'Optional[Sequence[float]]' = None, base_mode: 'str' = 'link') -> 'Dict[str, Any]'",
        "docstring": "Construct a linkset_info payload from selection data.",
        "full_name": "insightspike.algorithms.linkset_adapter.build_linkset_info",
        "tags": []
      },
      {
        "name": "LocalIGResult",
        "module": "insightspike.algorithms.local_information_gain_v2",
        "type": "class",
        "signature": "(total_ig: 'float', ig_value: 'float', computation_time: 'float', avg_surprise_before: 'float', avg_surprise_after: 'float', global_ig: 'float' = 0.0, homogenization: 'float' = 0.0, tension_reduction: 'float' = 0.0, max_surprise_after: 'float' = 0.0) -> None",
        "docstring": "LocalIGResult(total_ig: 'float', ig_value: 'float', computation_time: 'float', avg_surprise_before: 'float', avg_surprise_after: 'float', global_ig: 'float' = 0.0, homogenization: 'float' = 0.0, tension_reduction: 'float' = 0.0, max_surprise_after: 'float' = 0.0)",
        "full_name": "insightspike.algorithms.local_information_gain_v2.LocalIGResult",
        "tags": []
      },
      {
        "name": "LocalInformationGainV2",
        "module": "insightspike.algorithms.local_information_gain_v2",
        "type": "class",
        "signature": "(diffusion_steps: 'int' = 3, alpha: 'float' = 0.1, surprise_method: 'str' = 'entropy', normalize: 'bool' = True, teleport: 'float' = 0.02) -> 'None'",
        "docstring": "Minimal, self-contained Local IG implementation.",
        "full_name": "insightspike.algorithms.local_information_gain_v2.LocalInformationGainV2",
        "tags": []
      },
      {
        "name": "compute_local_ig",
        "module": "insightspike.algorithms.local_information_gain_v2",
        "type": "function",
        "signature": "(before: 'Any', after: 'Any', **kwargs: 'Any') -> 'float'",
        "docstring": "Convenience wrapper returning IG value as float (backward compatible).",
        "full_name": "insightspike.algorithms.local_information_gain_v2.compute_local_ig",
        "tags": []
      },
      {
        "name": "GraphEditDistance",
        "module": "insightspike.algorithms.metrics_selector",
        "type": "class",
        "signature": "(node_cost: float = 1.0, edge_cost: float = 1.0, optimization_level: Union[str, insightspike.algorithms.graph_edit_distance.OptimizationLevel] = <OptimizationLevel.STANDARD: 'standard'>, timeout_seconds: float = 5.0, max_graph_size_exact: int = 50)",
        "docstring": "Graph Edit Distance calculator for PyTorch Geometric graphs.",
        "full_name": "insightspike.algorithms.metrics_selector.GraphEditDistance",
        "tags": []
      },
      {
        "name": "InformationGain",
        ...
        "signature": "(method: Union[str, insightspike.algorithms.information_gain.EntropyMethod] = <EntropyMethod.CLUSTERING: 'clustering'>, k_clusters: int = 8, min_samples: int = 2, random_state: int = 42)",
        "docstring": "Information Gain calculator for measuring learning progress.",
        "full_name": "insightspike.algorithms.metrics_selector.InformationGain",
        "tags": []
      },
      {
        ...
        "type": "class",
        "signature": "(config=None)",
        "docstring": "Select and manage metric calculation methods",
        "full_name": "insightspike.algorithms.metrics_selector.MetricsSelector",
        "tags": []
      },
      {
        ...
        "signature": "(graph_before: 'Any', graph_after: 'Any', **kwargs) -> 'float'",
        "docstring": "Calculate \u0394GED for backward compatibility.",
        "full_name": "insightspike.algorithms.metrics_selector.advanced_delta_ged",
        "tags": []
      },
      {
        ...
        "signature": "(graph_before: 'Any', graph_after: 'Any', **kwargs) -> 'float'",
        "docstring": "Calculate \u0394IG for backward compatibility.",
        "full_name": "insightspike.algorithms.metrics_selector.advanced_delta_ig",
        "tags": []
      },
      {
        "name": "delta_ged",
        "module": "insightspike.algorithms.metrics_selector",
        "type": "function",
        "signature": "(graph1: Any, graph2: Any, config=None) -> float",
        "docstring": "Calculate \u0394GED with configured algorithm",
        "full_name": "insightspike.algorithms.metrics_selector.delta_ged",
        "tags": []
      },
      {
        "name": "delta_ged_pyg",
        ...
        "full_name": "insightspike.algorithms.metrics_selector.delta_ged_pyg",
        "tags": []
      },
      {
        "name": "delta_ig",
        ...
        "type": "function",
        "signature": "(graph1: Any, graph2: Any, config=None) -> float",
        "docstring": "Calculate \u0394IG with configured algorithm",
        "full_name": "insightspike.algorithms.metrics_selector.delta_ig",
        "tags": []
      },
      {
        "name": "delta_ig_pyg",
        ...
        "full_name": "insightspike.algorithms.metrics_selector.delta_ig_pyg",
        "tags": []
      },
      {
        "name": "get_metrics_selector",
        "module": "insightspike.algorithms.metrics_selector",
        "type": "function",
        "signature": "(config=None) -> insightspike.algorithms.metrics_selector.MetricsSelector",
        "docstring": "Get or create metrics selector",
        "full_name": "insightspike.algorithms.metrics_selector.get_metrics_selector",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.algorithms.metrics_selector.simple_delta_ged",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.algorithms.metrics_selector.simple_delta_ig",
        "tags": []
      },
      {
        "name": "ProperDeltaGED",
        "module": "insightspike.algorithms.proper_delta_ged",
        "type": "class",
        "signature": "()",
        "docstring": "Maintains reference graph state for proper \u0394GED calculation.",
        "full_name": "insightspike.algorithms.proper_delta_ged.ProperDeltaGED",
        "tags": []
      },
      {
        "name": "proper_delta_ged",
        "module": "insightspike.algorithms.proper_delta_ged",
        "type": "function",
        "signature": "(current_graph: Any, previous_graph: Optional[Any] = None, reference_graph: Optional[Any] = None) -> float",
        "docstring": "Calculate proper \u0394GED with persistent reference state.",
        "full_name": "insightspike.algorithms.proper_delta_ged.proper_delta_ged",
        "tags": []
      },
      {
        "name": "reset_ged_state",
        ...
        "signature": "()",
        "docstring": "Reset the global GED calculator state.",
        "full_name": "insightspike.algorithms.proper_delta_ged.reset_ged_state",
        "tags": []
      },
      {
        "name": "calculate_information_gain",
        "module": "insightspike.algorithms.proper_entropy",
        "type": "function",
        "signature": "(vectors_before: numpy.ndarray, vectors_after: numpy.ndarray) -> float",
        "docstring": "Calculate information gain as entropy reduction.",
        "full_name": "insightspike.algorithms.proper_entropy.calculate_information_gain",
        "tags": []
      },
      {
        "name": "calculate_vector_entropy",
        "module": "insightspike.algorithms.proper_entropy",
        "type": "function",
        "signature": "(vectors: numpy.ndarray) -> float",
        "docstring": "Calculate entropy based on vector similarity distribution.",
        "full_name": "insightspike.algorithms.proper_entropy.calculate_vector_entropy",
        "tags": []
      },
      {
        "name": "PyGAdapter",
        "module": "insightspike.algorithms.pyg_adapter",
        "type": "class",
        "signature": "()",
        "docstring": "Adapter to use PyTorch Geometric graphs with NetworkX-based algorithms",
        "full_name": "insightspike.algorithms.pyg_adapter.PyGAdapter",
        "tags": []
      },
      {
        "name": "PyGGraphEditDistance",
        "module": "insightspike.algorithms.pyg_adapter",
        "type": "class",
        "signature": "(structural_weight: float = 0.7, embedding_weight: float = 0.3, use_networkx: bool = True)",
        "docstring": "Graph Edit Distance calculator that works directly with PyG graphs.",
        "full_name": "insightspike.algorithms.pyg_adapter.PyGGraphEditDistance",
        "tags": []
      },
      {
        "name": "QueryContext",
        "module": "insightspike.algorithms.query_type_processor",
        "type": "class",
        "signature": "(query_text: Optional[str] = None, query_type: insightspike.algorithms.query_type_processor.QueryType = <QueryType.UNKNOWN: 'unknown'>, position: Optional[Tuple[float, float]] = None, direction: Optional[int] = None, language_embedding: Optional[numpy.ndarray] = None, spatial_bounds: Optional[Dict[str, float]] = None, metadata: Dict[str, Any] = None) -> None",
        "docstring": "Enhanced query context with type information.",
        "full_name": "insightspike.algorithms.query_type_processor.QueryContext",
        "tags": []
      },
      {
        "name": "QueryType",
        ...
        "type": "class",
        "signature": "(*values)",
        "docstring": "Types of queries with different processing needs.",
        "full_name": "insightspike.algorithms.query_type_processor.QueryType",
        "tags": []
      },
      {
        "name": "QueryTypeProcessor",
        "module": "insightspike.algorithms.query_type_processor",
        "type": "class",
        "signature": "(language_dim: int = 384, spatial_dim: int = 5, auto_detect: bool = True)",
        "docstring": "Processes queries differently based on their type.",
        "full_name": "insightspike.algorithms.query_type_processor.QueryTypeProcessor",
        "tags": []
      },
      {
        "name": "WakeModeGeDIG",
        ...
        "signature": "(**base_params)",
        "docstring": "Wake Mode geDIG calculator for efficient query processing.",
        "full_name": "insightspike.algorithms.query_type_processor.WakeModeGeDIG",
        "tags": []
      },
      {
        "name": "WakeModeResult",
        ...
        "signature": "(gedig_value: 'float', ged_value: 'float', ig_value: 'float', raw_ged: 'float' = 0.0, ged_norm_den: 'float' = 1.0, ig_raw: 'float' = 0.0, ig_norm_den: 'float' = 1.0, ig_z_score: 'float' = 0.0, delta_ged_norm: 'float' = 0.0, delta_sp_rel: 'float' = 0.0, delta_h_norm: 'float' = 0.0, structural_cost: 'float' = 0.0, structural_improvement: 'float' = 0.0, information_integration: 'float' = 0.0, entropy_before: 'float' = 0.0, entropy_after: 'float' = 0.0, ig_delta: 'float' = 0.0, variance_reduction: 'float' = 0.0, hop0_reward: 'float' = 0.0, aggregate_reward: 'float' = 0.0, reward: 'float' = 0.0, hop_results: 'Optional[Dict[int, HopResult]]' = None, computation_time: 'float' = 0.0, focal_nodes: 'Optional[Set[str]]' = None, version: 'str' = 'refactor_phaseA', spike: 'bool' = False, linkset_metrics: \"Optional['LinksetMetrics']\" = None, ged_min_proxy: 'float' = 0.0, mode: str = 'wake', pattern_match_score: float = 0.0, convergence_score: float = 0.0, efficiency_score: float = 0.0, nearest_patterns: Optional[List[str]] = None) -> None",
        "docstring": "Extended result for Wake Mode processing.",
        "full_name": "insightspike.algorithms.query_type_processor.WakeModeResult",
        "tags": []
      },
      {
        "name": "RehydrationStats",
        "module": "insightspike.algorithms.rehydration",
        "type": "class",
        "signature": "(attempted: 'int' = 0, restored: 'int' = 0, skipped: 'int' = 0) -> None",
        "docstring": "RehydrationStats(attempted: 'int' = 0, restored: 'int' = 0, skipped: 'int' = 0)",
        "full_name": "insightspike.algorithms.rehydration.RehydrationStats",
        "tags": []
      },
      {
        "name": "Rehydrator",
        ...
        "type": "class",
        "signature": "()",
        "docstring": "Minimal placeholder rehydrator.",
        "full_name": "insightspike.algorithms.rehydration.Rehydrator",
        "tags": []
      },
      {
        "name": "calculate_similarity_entropy",
        "module": "insightspike.algorithms.similarity_entropy",
        "type": "function",
        "signature": "(vectors: numpy.ndarray) -> float",
        "docstring": "Calculate entropy based on pairwise similarities.",
        "full_name": "insightspike.algorithms.similarity_entropy.calculate_similarity_entropy",
        "tags": []
      },
      {
        "name": "DistanceCache",
        "module": "insightspike.algorithms.sp_distcache",
        "type": "class",
        "signature": "(*, mode: 'str' = 'core', pair_samples: 'int' = 400) -> 'None'",
        "docstring": "",
        "full_name": "insightspike.algorithms.sp_distcache.DistanceCache",
        "tags": []
      },
      {
        "name": "PairSet",
        "module": "insightspike.algorithms.sp_distcache",
        "type": "class",
        "signature": "(pairs: 'List[Tuple[object, object, float]]', lb_avg: 'float') -> None",
        "docstring": "PairSet(pairs: 'List[Tuple[object, object, float]]', lb_avg: 'float')",
        "full_name": "insightspike.algorithms.sp_distcache.PairSet",
        "tags": []
      },
      {
        "name": "clustering_coefficient_entropy",
        "module": "insightspike.algorithms.structural_entropy",
        "type": "function",
        "signature": "(graph: Any) -> float",
        "docstring": "Calculate entropy based on clustering coefficient distribution.",
        "full_name": "insightspike.algorithms.structural_entropy.clustering_coefficient_entropy",
        "tags": []
      },
      {
        "name": "degree_distribution_entropy",
        ...
        "signature": "(graph: Any) -> float",
        "docstring": "Calculate entropy of the degree distribution.",
        "full_name": "insightspike.algorithms.structural_entropy.degree_distribution_entropy",
        "tags": []
      },
      {
        "name": "path_length_entropy",
        "module": "insightspike.algorithms.structural_entropy",
        "type": "function",
        "signature": "(graph: Any, sample_size: Optional[int] = 100) -> float",
        "docstring": "Calculate entropy based on shortest path length distribution.",
        "full_name": "insightspike.algorithms.structural_entropy.path_length_entropy",
        "tags": []
      },
      {
        ...
        "signature": "(graph: Any, weights: Optional[Dict[str, float]] = None) -> Dict[str, float]",
        "docstring": "Calculate multiple structural entropy measures.",
        "full_name": "insightspike.algorithms.structural_entropy.structural_entropy",
        "tags": []
      },
      {
        "name": "von_neumann_entropy",
        ...
        "signature": "(graph: Any, normalized: bool = True) -> float",
        "docstring": "Calculate Von Neumann entropy of the graph.",
        "full_name": "insightspike.algorithms.structural_entropy.von_neumann_entropy",
        "tags": []
      },
      {
        "name": "SimilarityResult",
        "module": "insightspike.algorithms.structural_similarity",
        "type": "class",
        "signature": "(similarity: 'float', method: 'str', is_analogy: 'bool' = False, signature_a: 'Optional[np.ndarray]' = None, signature_b: 'Optional[np.ndarray]' = None, domain_a: 'Optional[str]' = None, domain_b: 'Optional[str]' = None, is_cross_domain: 'bool' = False, details: 'Dict[str, Any]' = <factory>) -> None",
        "docstring": "Result of structural similarity evaluation.",
        "full_name": "insightspike.algorithms.structural_similarity.SimilarityResult",
        "tags": []
      },
      {
        "name": "StructuralSimilarityEvaluator",
        "module": "insightspike.algorithms.structural_similarity",
        "type": "class",
        "signature": "(config: \"'StructuralSimilarityConfig'\")",
        "docstring": "Evaluates structural similarity between graphs/subgraphs.",
        "full_name": "insightspike.algorithms.structural_similarity.StructuralSimilarityEvaluator",
        "tags": []
      },
      {
        "name": "compute_structural_similarity",
        "module": "insightspike.algorithms.structural_similarity",
        "type": "function",
        "signature": "(g1: 'nx.Graph', g2: 'nx.Graph', method: 'str' = 'signature', threshold: 'float' = 0.7) -> 'SimilarityResult'",
        "docstring": "Quick structural similarity computation.",
        "full_name": "insightspike.algorithms.structural_similarity.compute_structural_similarity",
        "tags": []
      },
      {
        "name": "StructuralSimilarityConfig",
        "module": "insightspike.algorithms.structure_enricher",
        "type": "class",
        ...
        "full_name": "insightspike.algorithms.structure_enricher.StructuralSimilarityConfig",
        "tags": []
      },
      {
        "name": "StructuralSimilarityEvaluator",
        ...
        "signature": "(config: \"'StructuralSimilarityConfig'\")",
        "docstring": "Evaluates structural similarity between graphs/subgraphs.",
        "full_name": "insightspike.algorithms.structure_enricher.StructuralSimilarityEvaluator",
        "tags": []
      },
      {
        "name": "StructureEnricher",
        "module": "insightspike.algorithms.structure_enricher",
        "type": "class",
        "signature": "(config: Optional[insightspike.config.models.StructuralSimilarityConfig] = None)",
        "docstring": "Enriches graph nodes with structural metadata.",
        "full_name": "insightspike.algorithms.structure_enricher.StructureEnricher",
        "tags": []
      },
      {
        "name": "discover_command",
        "module": "insightspike.cli.commands",
        "type": "function",
        "signature": "(ctx: typer.models.Context, corpus: Optional[pathlib._local.Path] = <typer.models.OptionInfo object at 0x147a65d10>, min_spike: float = <typer.models.OptionInfo object at 0x147a65e50>, max_insights: int = <typer.models.OptionInfo object at 0x147a65f90>, categories: Optional[str] = <typer.models.OptionInfo object at 0x147a660d0>, export_path: Optional[pathlib._local.Path] = <typer.models.OptionInfo object at 0x147a66210>, verbose: bool = <typer.models.OptionInfo object at 0x147a66350>)",
        "docstring": "Discover hidden insights and unexpected connections in your knowledge base.",
        "full_name": "insightspike.cli.commands.discover_command",
        "tags": []
      },
      {
        "name": "ConceptBridge",
        "module": "insightspike.cli.commands.bridge",
        "type": "class",
        "signature": "(agent: insightspike.implementations.agents.main_agent.MainAgent)",
        "docstring": "Find conceptual paths between seemingly unrelated ideas",
        "full_name": "insightspike.cli.commands.bridge.ConceptBridge",
        "tags": []
      },
      {
        "name": "SimpleRAGGraph",
        ...
        "full_name": "insightspike.cli.commands.bridge.SimpleRAGGraph",
        "tags": []
      },
      {
        "name": "bridge_command",
        "module": "insightspike.cli.commands.bridge",
        "type": "function",
        "signature": "(concept1: str = <typer.models.ArgumentInfo object at 0x147a9c6e0>, concept2: str = <typer.models.ArgumentInfo object at 0x147a66710>, max_hops: int = <typer.models.OptionInfo object at 0x147a66850>, top_k: int = <typer.models.OptionInfo object at 0x147a66990>, export: Optional[pathlib._local.Path] = <typer.models.OptionInfo object at 0x147a66ad0>, verbose: bool = <typer.models.OptionInfo object at 0x147a66c10>)",
        "docstring": "Find conceptual bridges between two ideas",
        "full_name": "insightspike.cli.commands.bridge.bridge_command",
        "tags": []
      },
      {
        "name": "visualize_bridge_path",
        "module": "insightspike.cli.commands.bridge",
        "type": "function",
        "signature": "(bridge_result: Dict) -> None",
        "docstring": "Visualize a bridge path with Rich",
        "full_name": "insightspike.cli.commands.bridge.visualize_bridge_path",
        "tags": []
      },
      {
        "name": "InsightDiscovery",
        "module": "insightspike.cli.commands.discover",
        "type": "class",
        "signature": "(agent: insightspike.implementations.agents.main_agent.MainAgent)",
        "docstring": "Handles insight discovery from knowledge base",
        "full_name": "insightspike.cli.commands.discover.InsightDiscovery",
        "tags": []
      },
      {
        "name": "MainAgent",
        ...
        "signature": "(config=None, datastore: Optional[insightspike.core.base.datastore.DataStore] = None)",
        "docstring": "Main orchestrating agent that coordinates all layers.",
        "full_name": "insightspike.cli.commands.discover.MainAgent",
        "tags": []
      },
      {
        "name": "discover_command",
        ...
        "signature": "(ctx: typer.models.Context, corpus: Optional[pathlib._local.Path] = <typer.models.OptionInfo object at 0x147a65d10>, min_spike: float = <typer.models.OptionInfo object at 0x147a65e50>, max_insights: int = <typer.models.OptionInfo object at 0x147a65f90>, categories: Optional[str] = <typer.models.OptionInfo object at 0x147a660d0>, export_path: Optional[pathlib._local.Path] = <typer.models.OptionInfo object at 0x147a66210>, verbose: bool = <typer.models.OptionInfo object at 0x147a66350>)",
        "docstring": "Discover hidden insights and unexpected connections in your knowledge base.",
        "full_name": "insightspike.cli.commands.discover.discover_command",
        "tags": []
      },
      {
        "name": "get_logger",
        ...
        "full_name": "insightspike.cli.commands.discover.get_logger",
        "tags": []
      },
      {
        "name": "DataStoreConfig",
        "module": "insightspike.cli.commands.graph",
        "type": "class",
        ...
        "full_name": "insightspike.cli.commands.graph.DataStoreConfig",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.cli.commands.graph.DataStoreFactory",
        "tags": []
      },
      {
        "name": "GraphAnalyzer",
        ...
        "type": "class",
        "signature": "(agent: insightspike.implementations.agents.main_agent.MainAgent)",
        "docstring": "Analyze and visualize knowledge graph structure",
        "full_name": "insightspike.cli.commands.graph.GraphAnalyzer",
        "tags": []
      },
      {
        "name": "SimpleRAGGraph",
        ...
        "signature": "(config=None, datastore: Optional[insightspike.core.base.datastore.DataStore] = None)",
        "docstring": "Main orchestrating agent that coordinates all layers.",
        "full_name": "insightspike.cli.commands.graph.SimpleRAGGraph",
        "tags": []
      },
      {
        ...
        "module": "insightspike.cli.commands.graph",
        "type": "function",
        "signature": "(export: Optional[pathlib._local.Path] = <typer.models.OptionInfo object at 0x147a66e90>, verbose: bool = <typer.models.OptionInfo object at 0x147a66fd0>)",
        "docstring": "Analyze knowledge graph structure and metrics",
        "full_name": "insightspike.cli.commands.graph.analyze_command",
        "tags": []
      },
      {
        "name": "graph_command",
        ...
        "type": "function",
        "signature": "()",
        "docstring": "Graph subcommand group",
        "full_name": "insightspike.cli.commands.graph.graph_command",
        "tags": []
      },
      {
        "name": "load_config",
        ...
        "full_name": "insightspike.cli.commands.graph.load_config",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.cli.commands.graph.resolve_project_relative",
        "tags": []
      },
      {
        ...
        "module": "insightspike.cli.commands.graph",
        "type": "function",
        "signature": "(namespace: str = <typer.models.OptionInfo object at 0x147a67610>, max_degree: int = <typer.models.OptionInfo object at 0x147a67750>, min_weight: float = <typer.models.OptionInfo object at 0x147a67890>, decay: float = <typer.models.OptionInfo object at 0x147a679d0>, keep_pinned: bool = <typer.models.OptionInfo object at 0x147a67b10>)",
        "docstring": "Run sleep/forget maintenance: edge pooling, weight decay, orphan pruning.",
        "full_name": "insightspike.cli.commands.graph.sleep_gc_command",
        "tags": []
      },
      {
        ...
        "module": "insightspike.cli.commands.graph",
        "type": "function",
        "signature": "(output: pathlib._local.Path = <typer.models.ArgumentInfo object at 0x147a67110>, format: str = <typer.models.OptionInfo object at 0x147a67250>, insights_only: bool = <typer.models.OptionInfo object at 0x147a67390>, verbose: bool = <typer.models.OptionInfo object at 0x147a674d0>)",
        "docstring": "Generate interactive visualization of the knowledge graph",
        "full_name": "insightspike.cli.commands.graph.visualize_command",
        "tags": []
      },
      {
        "name": "visualize_graph_metrics",
        "module": "insightspike.cli.commands.graph",
        "type": "function",
        "signature": "(analysis: Dict[str, Any]) -> None",
        "docstring": "Display graph metrics in a beautiful format",
        "full_name": "insightspike.cli.commands.graph.visualize_graph_metrics",
        "tags": []
      },
      {
        "name": "InsightFactRegistry",
        "module": "insightspike.cli.legacy",
        "type": "class",
        ...
        "full_name": "insightspike.cli.legacy.InsightFactRegistry",
        "tags": []
      },
      {
        "name": "MainAgent",
        ...
        "signature": "(config=None, datastore: Optional[insightspike.core.base.datastore.DataStore] = None)",
        "docstring": "Main orchestrating agent that coordinates all layers.",
        "full_name": "insightspike.cli.legacy.MainAgent",
        "tags": []
      },
      {
        "name": "ask",
        "module": "insightspike.cli.legacy",
        "type": "function",
        "signature": "(question: str = <typer.models.ArgumentInfo object at 0x147d30f50>)",
        "docstring": "[DEPRECATED] Use 'spike ask' instead. Legacy ask command.",
        "full_name": "insightspike.cli.legacy.ask",
        "tags": []
      },
      {
        "name": "config_info",
        ...
        "full_name": "insightspike.cli.legacy.config_info",
        "tags": []
      },
      {
        "name": "get_config",
        ...
        "signature": "() -> insightspike.config.models.InsightSpikeConfig",
        "docstring": "Get current configuration or load defaults",
        "full_name": "insightspike.cli.legacy.get_config",
        "tags": []
      },
      {
        "name": "load_corpus",
        ...
        "docstring": "",
        "full_name": "insightspike.cli.legacy.load_corpus",
        "tags": []
      },
      {
        "name": "load_documents",
        "module": "insightspike.cli.legacy",
        "type": "function",
        "signature": "(path: pathlib._local.Path = <typer.models.ArgumentInfo object at 0x147d31090>)",
        "docstring": "Load documents into the agent's memory (without graph update)",
        "full_name": "insightspike.cli.legacy.load_documents",
        "tags": []
      },
      {
        "name": "main",
        ...
        "type": "function",
        "signature": "()",
        "docstring": "Main CLI entry point for Poetry scripts",
        "full_name": "insightspike.cli.legacy.main",
        "tags": []
      },
      {
        "name": "main_callback",
        ...
        "type": "function",
        "signature": "()",
        "docstring": "InsightSpike Legacy CLI",
        "full_name": "insightspike.cli.legacy.main_callback",
        "tags": []
      },
      {
        "name": "stats",
        ...
        "type": "function",
        "signature": "()",
        "docstring": "[DEPRECATED] Use 'spike stats' instead. Show agent statistics",
        "full_name": "insightspike.cli.legacy.stats",
        "tags": []
      },
      {
        "name": "test",
      ...
      },
      {
        ...
        "module": "insightspike.cli.spike",
        "type": "function",
        "signature": "(ctx: typer.models.Context, action: str = <typer.models.ArgumentInfo object at 0x147d30050>, key: Optional[str] = <typer.models.ArgumentInfo object at 0x147d30190>, value: Optional[str] = <typer.models.ArgumentInfo object at 0x147d302d0>)",
      ...
      },
      {
        ...
        "module": "insightspike.cli.spike",
        "type": "function",
        "signature": "(ctx: typer.models.Context, path: pathlib._local.Path, preset: str = <typer.models.OptionInfo object at 0x147a67d90>)",
      ...
      },
      {
        ...
        "module": "insightspike.cli.spike",
        "type": "function",
        "signature": "(ctx: typer.models.Context, name: str = <typer.models.OptionInfo object at 0x147d30550>, episodes: int = <typer.models.OptionInfo object at 0x147d30690>)",
      ...
      },
      {
        ...
        "module": "insightspike.cli.spike",
        "type": "function",
        "signature": "(ctx: typer.models.Context, limit: int = <typer.models.OptionInfo object at 0x147d307d0>)",
      ...
      },
      {
        ...
        "module": "insightspike.cli.spike",
        "type": "function",
        "signature": "(ctx: typer.models.Context, concept: str, limit: int = <typer.models.OptionInfo object at 0x147d30910>)",
      ...
      },
      {
        ...
        "module": "insightspike.cli.spike",
        "type": "function",
        "signature": "(ctx: typer.models.Context, question: str, preset: str = <typer.models.OptionInfo object at 0x147a66d50>, verbose: bool = <typer.models.OptionInfo object at 0x147a67c50>)",
      ...
      },
      {
        ...
        "module": "insightspike.core",
        "type": "class",
        "signature": "(memory_manager: insightspike.interfaces.memory.IMemoryManager, datastore: insightspike.interfaces.datastore.IDataStore, embedder: insightspike.interfaces.embedder.IEmbedder, graph_builder: insightspike.implementations.graph.pyg_graph_builder.PyGGraphBuilder)",
        "docstring": "Manages memory operations and episode lifecycle.",
        "full_name": "insightspike.core.MemoryController",
        "tags": []
      },
      {
        ...
        "module": "insightspike.core",
        "type": "class",
        "signature": "(llm_provider: insightspike.interfaces.llm.ILLMProvider, memory_search: insightspike.interfaces.memory.IMemorySearch, graph_reasoner: insightspike.implementations.layers.layer3_graph_reasoner.L3GraphReasoner, llm_interface: insightspike.implementations.layers.layer4_llm_interface.L4LLMInterface)",
        "docstring": "Handles the core reasoning cycle logic.",
        "full_name": "insightspike.core.ReasoningEngine",
        "tags": []
      },
      {
        ...
        "module": "insightspike.core",
        "type": "class",
        "signature": "(llm_provider: insightspike.interfaces.llm.ILLMProvider, response_style: str = 'concise')",
        "docstring": "Generates and formats responses for user queries.",
        "full_name": "insightspike.core.ResponseGenerator",
        "tags": []
      },
      {
        "name": "ActionSpace",
      ...
      {
        "name": "Episode",
        "module": "insightspike.core.memory_controller",
        "type": "class",
        "signature": "(text: str, vec: numpy.ndarray, c: float = 0.5, timestamp: float = <factory>, metadata: Dict[str, Any] = <factory>, episode_type: str = 'experience', selection_count: int = 0, creation_time: float = <factory>, confidence: Optional[float] = None) -> None",
        "docstring": "Single memory entry with vector embedding, text, and C-value.",
        "full_name": "insightspike.core.memory_controller.Episode",
        "tags": []
      },
      {
        "name": "IDataStore",
        ...
        "docstring": "Full datastore interface with search capabilities.",
        "full_name": "insightspike.core.memory_controller.IDataStore",
        "tags": []
      },
      {
        "name": "IEmbedder",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for text embedders.",
        "full_name": "insightspike.core.memory_controller.IEmbedder",
        "tags": []
      },
      {
        "name": "IMemoryManager",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for memory management.",
        "full_name": "insightspike.core.memory_controller.IMemoryManager",
        "tags": []
      },
      {
        "name": "MemoryController",
        ...
        "signature": "(memory_manager: insightspike.interfaces.memory.IMemoryManager, datastore: insightspike.interfaces.datastore.IDataStore, embedder: insightspike.interfaces.embedder.IEmbedder, graph_builder: insightspike.implementations.graph.pyg_graph_builder.PyGGraphBuilder)",
        "docstring": "Manages memory operations and episode lifecycle.",
        "full_name": "insightspike.core.memory_controller.MemoryController",
        "tags": []
      },
      {
        "name": "PyGGraphBuilder",
        "module": "insightspike.core.memory_controller",
        "type": "class",
        "signature": "(config=None)",
        "docstring": "Graph builder using PyTorch Geometric for advanced graph operations.",
        "full_name": "insightspike.core.memory_controller.PyGGraphBuilder",
        "tags": []
      },
      {
        "name": "CycleResult",
        "module": "insightspike.core.reasoning_engine",
        "type": "class",
        "signature": "(response: str, reasoning_trace: str, memory_used: List[Dict[str, Any]], spike_detected: bool, graph_metrics: Dict[str, float], reasoning_quality: float, convergence_score: float, has_spike: bool) -> None",
        "docstring": "Result from a single reasoning cycle.",
        "full_name": "insightspike.core.reasoning_engine.CycleResult",
        "tags": []
      },
      {
        "name": "ILLMProvider",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for LLM providers.",
        "full_name": "insightspike.core.reasoning_engine.ILLMProvider",
        "tags": []
      },
      {
        "name": "IMemorySearch",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for advanced memory search with graph support.",
        "full_name": "insightspike.core.reasoning_engine.IMemorySearch",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.core.reasoning_engine.L3GraphReasoner",
        "tags": []
      },
      {
        "name": "L4LLMInterface",
        ...
        "full_name": "insightspike.core.reasoning_engine.L4LLMInterface",
        "tags": []
      },
      {
        "name": "ReasoningEngine",
        ...
        "signature": "(llm_provider: insightspike.interfaces.llm.ILLMProvider, memory_search: insightspike.interfaces.memory.IMemorySearch, graph_reasoner: insightspike.implementations.layers.layer3_graph_reasoner.L3GraphReasoner, llm_interface: insightspike.implementations.layers.layer4_llm_interface.L4LLMInterface)",
        "docstring": "Handles the core reasoning cycle logic.",
        "full_name": "insightspike.core.reasoning_engine.ReasoningEngine",
        "tags": []
      },
      {
        "name": "CycleResult",
        "module": "insightspike.core.response_generator",
        "type": "class",
        "signature": "(response: str, reasoning_trace: str, memory_used: List[Dict[str, Any]], spike_detected: bool, graph_metrics: Dict[str, float], reasoning_quality: float, convergence_score: float, has_spike: bool) -> None",
        "docstring": "Result from a single reasoning cycle.",
        "full_name": "insightspike.core.response_generator.CycleResult",
        "tags": []
      },
      {
        "name": "ILLMProvider",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for LLM providers.",
        "full_name": "insightspike.core.response_generator.ILLMProvider",
        "tags": []
      },
      {
        "name": "ResponseGenerator",
        ...
        "signature": "(llm_provider: insightspike.interfaces.llm.ILLMProvider, response_style: str = 'concise')",
        "docstring": "Generates and formats responses for user queries.",
        "full_name": "insightspike.core.response_generator.ResponseGenerator",
        "tags": []
      },
      {
        ...
        "module": "insightspike.core.response_generator",
        "type": "class",
        "signature": "(question: str, answer: str, reasoning: Optional[str] = None, confidence: float = 0.0, sources: Optional[List[str]] = None, metadata: Optional[Dict[str, Any]] = None) -> None",
        "docstring": "Template for response formatting.",
        "full_name": "insightspike.core.response_generator.ResponseTemplate",
        "tags": []
      },
      {
        "name": "CycleResult",
      ...
      {
        "name": "DIContainer",
        "module": "insightspike.di",
        "type": "class",
        "signature": "()",
        "docstring": "Simple dependency injection container.",
        "full_name": "insightspike.di.DIContainer",
        "tags": []
      },
      {
        "name": "DataStoreProvider",
        "module": "insightspike.di",
        "type": "class",
        "signature": "()",
        "docstring": "Provider for IDataStore implementations.",
        "full_name": "insightspike.di.DataStoreProvider",
        "tags": []
      },
      {
        ...
        "type": "class",
        "signature": "()",
        "docstring": "Provider for IEmbedder implementations.",
        "full_name": "insightspike.di.EmbedderProvider",
        "tags": []
      },
      {
        "name": "GraphBuilderProvider",
        "module": "insightspike.di",
        "type": "class",
        "signature": "()",
        "docstring": "Provider for IGraphBuilder implementations.",
        "full_name": "insightspike.di.GraphBuilderProvider",
        "tags": []
      },
      {
        ...
        "type": "class",
        "signature": "()",
        "docstring": "Factory for ILLMProvider implementations.",
        "full_name": "insightspike.di.LLMProviderFactory",
        "tags": []
      },
      {
        "name": "MemoryManagerProvider",
        "module": "insightspike.di",
        "type": "class",
        "signature": "()",
        "docstring": "Provider for IMemoryManager implementations.",
        "full_name": "insightspike.di.MemoryManagerProvider",
        "tags": []
      },
      {
        ...
        "type": "class",
        "signature": "()",
        "docstring": "Abstract base for service providers.",
        "full_name": "insightspike.di.ServiceProvider",
        "tags": []
      },
      {
        "name": "DIContainer",
        "module": "insightspike.di.container",
        "type": "class",
        "signature": "()",
        "docstring": "Simple dependency injection container.",
        "full_name": "insightspike.di.container.DIContainer",
        "tags": []
      },
      {
        ...
        "module": "insightspike.di.container",
        "type": "class",
        "signature": "(factory: Callable[[ForwardRef('DIContainer')], Any])",
        "docstring": "Provider that creates a new instance every time.",
        "full_name": "insightspike.di.container.FactoryProvider",
        "tags": []
      },
      {
        "name": "ServiceProvider",
        ...
        "signature": "()",
        "docstring": "Abstract base for service providers.",
        "full_name": "insightspike.di.container.ServiceProvider",
        "tags": []
      },
      {
        ...
        "type": "class",
        "signature": "(factory: Callable[[ForwardRef('DIContainer')], Any])",
        "docstring": "Provider that returns the same instance every time.",
        "full_name": "insightspike.di.container.SingletonProvider",
        "tags": []
      },
      {
        "name": "DataStoreFactory",
        "module": "insightspike.di.providers",
        "type": "class",
        "signature": "()",
        "docstring": "Factory for creating DataStore instances",
        "full_name": "insightspike.di.providers.DataStoreFactory",
        "tags": []
      },
      {
        "name": "DataStoreProvider",
        ...
        "signature": "()",
        "docstring": "Provider for IDataStore implementations.",
        "full_name": "insightspike.di.providers.DataStoreProvider",
        "tags": []
      },
      {
        "name": "EmbedderProvider",
        ...
        "signature": "()",
        "docstring": "Provider for IEmbedder implementations.",
        "full_name": "insightspike.di.providers.EmbedderProvider",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.di.providers.EmbeddingManager",
        "tags": []
      },
      {
        "name": "GraphBuilderProvider",
        ...
        "signature": "()",
        "docstring": "Provider for IGraphBuilder implementations.",
        "full_name": "insightspike.di.providers.GraphBuilderProvider",
        "tags": []
      },
      {
        "name": "IDataStore",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Full datastore interface with search capabilities.",
        "full_name": "insightspike.di.providers.IDataStore",
        "tags": []
      },
      {
        "name": "IEmbedder",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for text embedders.",
        "full_name": "insightspike.di.providers.IEmbedder",
        "tags": []
      },
      {
        "name": "IGraphBuilder",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for building PyTorch Geometric graphs.",
        "full_name": "insightspike.di.providers.IGraphBuilder",
        "tags": []
      },
      {
        "name": "ILLMProvider",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for LLM providers.",
        "full_name": "insightspike.di.providers.ILLMProvider",
        "tags": []
      },
      {
        "name": "IMemoryManager",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for memory management.",
        "full_name": "insightspike.di.providers.IMemoryManager",
        "tags": []
      },
      {
        "name": "InsightSpikeConfig",
        ...
        "signature": "(*, environment: Literal['development', 'experiment', 'production', 'research', 'test', 'testing', 'custom'] = 'development', pre_warm_models: bool = True, llm: insightspike.config.models.LLMConfig = <factory>, embedding: insightspike.config.models.EmbeddingConfig = <factory>, memory: insightspike.config.models.MemoryConfig = <factory>, graph: insightspike.config.models.GraphConfig = <factory>, monitoring: insightspike.config.models.MonitoringConfig = <factory>, logging: insightspike.config.models.LoggingConfig = <factory>, paths: insightspike.config.models.PathsConfig = <factory>, processing: insightspike.config.models.ProcessingConfig = <factory>, output: insightspike.config.models.OutputConfig = <factory>, datastore: insightspike.config.models.DataStoreConfig = <factory>, metrics: insightspike.config.models.MetricsConfig = <factory>, reasoning: insightspike.config.models.ReasoningConfig = <factory>, performance: insightspike.config.models.PerformanceConfig = <factory>, vector_search: insightspike.config.models.VectorSearchConfig = <factory>, wake_sleep: insightspike.config.wake_sleep_config.WakeSleepConfig = <factory>) -> None",
        "docstring": "Complete InsightSpike configuration - clean structure without backward compatibility",
        "full_name": "insightspike.di.providers.InsightSpikeConfig",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.di.providers.L2MemoryManager",
        "tags": []
      },
      {
        "name": "LLMProviderFactory",
        ...
        "signature": "()",
        "docstring": "Factory for ILLMProvider implementations.",
        "full_name": "insightspike.di.providers.LLMProviderFactory",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.di.providers.LLMProviderRegistry",
        "tags": []
      },
      {
        "name": "MemoryManagerProvider",
        ...
        "signature": "()",
        "docstring": "Provider for IMemoryManager implementations.",
        "full_name": "insightspike.di.providers.MemoryManagerProvider",
        "tags": []
      },
      {
        "name": "PyGGraphBuilder",
        ...
        "signature": "(config=None)",
        "docstring": "Graph builder using PyTorch Geometric for advanced graph operations.",
        "full_name": "insightspike.di.providers.PyGGraphBuilder",
        "tags": []
      },
      {
      ...
      {
        "name": "AdaptiveExplorer",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(exploration_temperature: float = 1.0)",
        "docstring": "Adaptive exploration strategy for query transformation",
        "full_name": "insightspike.features.query_transformation.AdaptiveExplorer",
        "tags": []
      },
      {
        "name": "EnhancedQueryTransformer",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(embedding_model_name: str = 'all-MiniLM-L6-v2', use_multi_hop: bool = True, enable_branching: bool = True, max_branches: int = 3)",
        "docstring": "Enhanced query transformer with advanced features",
        "full_name": "insightspike.features.query_transformation.EnhancedQueryTransformer",
        "tags": []
      },
      {
        ...
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(pattern_id: str, initial_query_type: str, transformation_path: List[str], absorbed_concepts: List[str], final_insights: List[str], success_score: float, avg_confidence_gain: float, num_hops: int, branches_used: List[str], timestamp: str = '') -> None",
        "docstring": "Represents a successful query evolution pattern",
        "full_name": "insightspike.features.query_transformation.EvolutionPattern",
        "tags": []
      },
      {
        ...
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(db_path: Optional[pathlib._local.Path] = None, enable_learning: bool = True)",
        "docstring": "Track and learn from query evolution patterns",
        "full_name": "insightspike.features.query_transformation.EvolutionTracker",
        "tags": []
      },
      {
        "name": "MultiHopGNN",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(feature_dim: int = 384, hidden_dim: int = 256, num_hops: int = 3)",
        "docstring": "GNN with multi-hop message passing and attention",
        "full_name": "insightspike.features.query_transformation.MultiHopGNN",
        "tags": []
      },
      {
        ...
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(db_path: pathlib._local.Path)",
        "docstring": "SQLite database for storing evolution patterns",
        "full_name": "insightspike.features.query_transformation.PatternDatabase",
        "tags": []
      },
      {
        "name": "QueryBranch",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(branch_id: str, parent_state: insightspike.features.query_transformation.query_state.QueryState, current_state: insightspike.features.query_transformation.query_state.QueryState, exploration_direction: str, priority: float = 0.5, discovered_paths: List[List[str]] = <factory>) -> None",
        "docstring": "Represents a branch in query exploration",
        "full_name": "insightspike.features.query_transformation.QueryBranch",
        "tags": []
      },
      {
        "name": "QueryState",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(text: str, embedding: Optional[torch.Tensor] = None, timestamp: datetime.datetime = <factory>, stage: str = 'initial', confidence: float = 0.0, color: str = 'yellow', absorbed_concepts: List[str] = <factory>, discovered_connections: List[tuple] = <factory>, insights: List[str] = <factory>, graph_position: Optional[Dict[str, Any]] = None, connected_nodes: List[str] = <factory>, edge_weights: Dict[str, float] = <factory>, transformation_magnitude: float = 0.0, information_gain: float = 0.0, structural_change: float = 0.0) -> None",
        "docstring": "Represents the state of a query at a point in time",
        "full_name": "insightspike.features.query_transformation.QueryState",
        "tags": []
      },
      {
        "name": "QueryTransformationHistory",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(initial_query: str, states: List[insightspike.features.query_transformation.query_state.QueryState] = <factory>) -> None",
        "docstring": "Tracks the complete transformation journey of a query",
        "full_name": "insightspike.features.query_transformation.QueryTransformationHistory",
        "tags": []
      },
      {
        ...
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(embedding_model_name: str = 'all-MiniLM-L6-v2', use_gnn: bool = True)",
        "docstring": "Transforms queries through graph exploration",
        "full_name": "insightspike.features.query_transformation.QueryTransformer",
        "tags": []
      },
      {
        "name": "QueryTypeClassifier",
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "()",
        "docstring": "Classify queries into types for pattern matching",
        "full_name": "insightspike.features.query_transformation.QueryTypeClassifier",
        "tags": []
      },
      {
        ...
        "module": "insightspike.features.query_transformation",
        "type": "class",
        "signature": "(pattern_db: insightspike.features.query_transformation.evolution_tracker.PatternDatabase)",
        "docstring": "Analyze query evolution trajectories for insights",
        "full_name": "insightspike.features.query_transformation.TrajectoryAnalyzer",
        "tags": []
      },
      {
        "name": "AdaptiveExplorer",
        "module": "insightspike.features.query_transformation.enhanced_query_transformer",
        "type": "class",
        "signature": "(exploration_temperature: float = 1.0)",
        "docstring": "Adaptive exploration strategy for query transformation",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.AdaptiveExplorer",
        "tags": []
      },
      {
        "name": "EnhancedQueryTransformer",
        ...
        "signature": "(embedding_model_name: str = 'all-MiniLM-L6-v2', use_multi_hop: bool = True, enable_branching: bool = True, max_branches: int = 3)",
        "docstring": "Enhanced query transformer with advanced features",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.EnhancedQueryTransformer",
        "tags": []
      },
      {
        "name": "MultiHopGNN",
        ...
        "signature": "(feature_dim: int = 384, hidden_dim: int = 256, num_hops: int = 3)",
        "docstring": "GNN with multi-hop message passing and attention",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.MultiHopGNN",
        "tags": []
      },
      {
        "name": "QueryBranch",
        ...
        "signature": "(branch_id: str, parent_state: insightspike.features.query_transformation.query_state.QueryState, current_state: insightspike.features.query_transformation.query_state.QueryState, exploration_direction: str, priority: float = 0.5, discovered_paths: List[List[str]] = <factory>) -> None",
        "docstring": "Represents a branch in query exploration",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.QueryBranch",
        "tags": []
      },
      {
        "name": "QueryGraphGNN",
        "module": "insightspike.features.query_transformation.enhanced_query_transformer",
        "type": "class",
        "signature": "(feature_dim: int = 384, hidden_dim: int = 256)",
        "docstring": "GNN that includes query as a special node",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.QueryGraphGNN",
        "tags": []
      },
      {
        "name": "QueryState",
        ...
        "signature": "(text: str, embedding: Optional[torch.Tensor] = None, timestamp: datetime.datetime = <factory>, stage: str = 'initial', confidence: float = 0.0, color: str = 'yellow', absorbed_concepts: List[str] = <factory>, discovered_connections: List[tuple] = <factory>, insights: List[str] = <factory>, graph_position: Optional[Dict[str, Any]] = None, connected_nodes: List[str] = <factory>, edge_weights: Dict[str, float] = <factory>, transformation_magnitude: float = 0.0, information_gain: float = 0.0, structural_change: float = 0.0) -> None",
        "docstring": "Represents the state of a query at a point in time",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.QueryState",
        "tags": []
      },
      {
        "name": "QueryTransformer",
        ...
        "signature": "(embedding_model_name: str = 'all-MiniLM-L6-v2', use_gnn: bool = True)",
        "docstring": "Transforms queries through graph exploration",
        "full_name": "insightspike.features.query_transformation.enhanced_query_transformer.QueryTransformer",
        "tags": []
      },
      {
        "name": "EvolutionPattern",
        "module": "insightspike.features.query_transformation.evolution_tracker",
        "type": "class",
        "signature": "(pattern_id: str, initial_query_type: str, transformation_path: List[str], absorbed_concepts: List[str], final_insights: List[str], success_score: float, avg_confidence_gain: float, num_hops: int, branches_used: List[str], timestamp: str = '') -> None",
        "docstring": "Represents a successful query evolution pattern",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.EvolutionPattern",
        "tags": []
      },
      {
        "name": "EvolutionTracker",
        ...
        "signature": "(db_path: Optional[pathlib._local.Path] = None, enable_learning: bool = True)",
        "docstring": "Track and learn from query evolution patterns",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.EvolutionTracker",
        "tags": []
      },
      {
        "name": "PatternDatabase",
        ...
        "signature": "(db_path: pathlib._local.Path)",
        "docstring": "SQLite database for storing evolution patterns",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.PatternDatabase",
        "tags": []
      },
      {
        "name": "QueryState",
        ...
        "signature": "(text: str, embedding: Optional[torch.Tensor] = None, timestamp: datetime.datetime = <factory>, stage: str = 'initial', confidence: float = 0.0, color: str = 'yellow', absorbed_concepts: List[str] = <factory>, discovered_connections: List[tuple] = <factory>, insights: List[str] = <factory>, graph_position: Optional[Dict[str, Any]] = None, connected_nodes: List[str] = <factory>, edge_weights: Dict[str, float] = <factory>, transformation_magnitude: float = 0.0, information_gain: float = 0.0, structural_change: float = 0.0) -> None",
        "docstring": "Represents the state of a query at a point in time",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.QueryState",
        "tags": []
      },
      {
        "name": "QueryTransformationHistory",
        ...
        "signature": "(initial_query: str, states: List[insightspike.features.query_transformation.query_state.QueryState] = <factory>) -> None",
        "docstring": "Tracks the complete transformation journey of a query",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.QueryTransformationHistory",
        "tags": []
      },
      {
        "name": "QueryTypeClassifier",
        ...
        "signature": "()",
        "docstring": "Classify queries into types for pattern matching",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.QueryTypeClassifier",
        "tags": []
      },
      {
        "name": "TrajectoryAnalyzer",
        ...
        "signature": "(pattern_db: insightspike.features.query_transformation.evolution_tracker.PatternDatabase)",
        "docstring": "Analyze query evolution trajectories for insights",
        "full_name": "insightspike.features.query_transformation.evolution_tracker.TrajectoryAnalyzer",
        "tags": []
      },
      {
        "name": "QueryState",
        "module": "insightspike.features.query_transformation.query_state",
        "type": "class",
        "signature": "(text: str, embedding: Optional[torch.Tensor] = None, timestamp: datetime.datetime = <factory>, stage: str = 'initial', confidence: float = 0.0, color: str = 'yellow', absorbed_concepts: List[str] = <factory>, discovered_connections: List[tuple] = <factory>, insights: List[str] = <factory>, graph_position: Optional[Dict[str, Any]] = None, connected_nodes: List[str] = <factory>, edge_weights: Dict[str, float] = <factory>, transformation_magnitude: float = 0.0, information_gain: float = 0.0, structural_change: float = 0.0) -> None",
        "docstring": "Represents the state of a query at a point in time",
        "full_name": "insightspike.features.query_transformation.query_state.QueryState",
        "tags": []
      },
      {
        "name": "QueryTransformationHistory",
        ...
        "signature": "(initial_query: str, states: List[insightspike.features.query_transformation.query_state.QueryState] = <factory>) -> None",
        "docstring": "Tracks the complete transformation journey of a query",
        "full_name": "insightspike.features.query_transformation.query_state.QueryTransformationHistory",
        "tags": []
      },
      {
        "name": "GraphEditDistance",
        "module": "insightspike.features.query_transformation.query_transformer",
        "type": "class",
        "signature": "(node_cost: float = 1.0, edge_cost: float = 1.0, optimization_level: Union[str, insightspike.algorithms.graph_edit_distance.OptimizationLevel] = <OptimizationLevel.STANDARD: 'standard'>, timeout_seconds: float = 5.0, max_graph_size_exact: int = 50)",
        "docstring": "Graph Edit Distance calculator for PyTorch Geometric graphs.",
        "full_name": "insightspike.features.query_transformation.query_transformer.GraphEditDistance",
        "tags": []
      },
      {
        "name": "QueryGraphGNN",
        ...
        "signature": "(feature_dim: int = 384, hidden_dim: int = 256)",
        "docstring": "GNN that includes query as a special node",
        "full_name": "insightspike.features.query_transformation.query_transformer.QueryGraphGNN",
        "tags": []
      },
      {
        "name": "QueryState",
        ...
        "signature": "(text: str, embedding: Optional[torch.Tensor] = None, timestamp: datetime.datetime = <factory>, stage: str = 'initial', confidence: float = 0.0, color: str = 'yellow', absorbed_concepts: List[str] = <factory>, discovered_connections: List[tuple] = <factory>, insights: List[str] = <factory>, graph_position: Optional[Dict[str, Any]] = None, connected_nodes: List[str] = <factory>, edge_weights: Dict[str, float] = <factory>, transformation_magnitude: float = 0.0, information_gain: float = 0.0, structural_change: float = 0.0) -> None",
        "docstring": "Represents the state of a query at a point in time",
        "full_name": "insightspike.features.query_transformation.query_transformer.QueryState",
        "tags": []
      },
      {
        "name": "QueryTransformationHistory",
        ...
        "signature": "(initial_query: str, states: List[insightspike.features.query_transformation.query_state.QueryState] = <factory>) -> None",
        "docstring": "Tracks the complete transformation journey of a query",
        "full_name": "insightspike.features.query_transformation.query_transformer.QueryTransformationHistory",
        "tags": []
      },
      {
        "name": "QueryTransformer",
        ...
        "signature": "(embedding_model_name: str = 'all-MiniLM-L6-v2', use_gnn: bool = True)",
        "docstring": "Transforms queries through graph exploration",
        "full_name": "insightspike.features.query_transformation.query_transformer.QueryTransformer",
        "tags": []
      },
      {
        "name": "GraphBuilder",
      ...
      },
      {
        ...
        "module": "insightspike.graph.edge_reevaluator",
        "type": "class",
        "signature": "(similarity_threshold: float = 0.7, new_edge_threshold: float = 0.8, max_new_edges_per_node: int = 5, edge_decay_factor: float = 0.9)",
        "docstring": "Re-evaluates edges after message passing to discover new connections",
        "full_name": "insightspike.graph.edge_reevaluator.EdgeReevaluator",
        "tags": []
      },
      {
        "name": "MessagePassing",
        "module": "insightspike.graph.message_passing",
        "type": "class",
        "signature": "(alpha: float = 0.3, iterations: int = 3, aggregation: str = 'weighted_mean', self_loop_weight: float = 0.5, decay_factor: float = 0.8)",
        "docstring": "Question-aware message passing for knowledge graphs.",
        "full_name": "insightspike.graph.message_passing.MessagePassing",
        "tags": []
      },
      {
        "name": "OptimizedMessagePassing",
        "module": "insightspike.graph.message_passing_optimized",
        "type": "class",
        "signature": "(alpha: float = 0.3, iterations: int = 3, max_hops: int = 1, aggregation: str = 'weighted_mean', self_loop_weight: float = 0.5, decay_factor: float = 0.8, convergence_threshold: float = 0.0001, similarity_threshold: float = 0.3)",
        "docstring": "Optimized question-aware message passing with hop limitation.",
        "full_name": "insightspike.graph.message_passing_optimized.OptimizedMessagePassing",
        "tags": []
      },
      {
      ...
      },
      {
        ...
        "signature": "(config: Union[insightspike.implementations.layers.layer4_llm_interface.LLMConfig, ForwardRef('InsightSpikeConfig'), Dict[str, Any], NoneType] = None)",
        "docstring": "Layer 4 Language Interface - Natural language synthesis.",
        "full_name": "insightspike.implementations.layers.L4LLMInterface",
        "tags": []
      },
      {
        "name": "LLMConfig",
        ...
        "full_name": "insightspike.implementations.layers.LLMConfig",
        "tags": []
      },
      {
        ...
        "full_name": "insightspike.implementations.layers.LLMProviderType",
        "tags": []
      },
      {
        "name": "MemoryConfig",
      ...
      },
      {
        ...
        "full_name": "insightspike.implementations.layers.get_llm_provider",
        "tags": []
      },
      {
      ...
      {
        "name": "ScalableGraphManager",
        "module": "insightspike.implementations.memory.scalable_graph_manager",
        "type": "class",
        "signature": "(embedding_dim: int = 384, similarity_threshold: float = 0.3, top_k: int = 50, conflict_threshold: float = 0.8)",
        "docstring": "Scalable graph management with FAISS-based similarity search.",
        "full_name": "insightspike.implementations.memory.scalable_graph_manager.ScalableGraphManager",
        "tags": []
      },
      {
        "name": "VectorIndexFactory",
        ...
        "signature": "()",
        "docstring": "Factory for creating vector indices.",
        "full_name": "insightspike.implementations.memory.scalable_graph_manager.VectorIndexFactory",
        "tags": []
      },
      {
        "name": "BackwardCompatibleWrapper",
      ...
      {
        "name": "IAgent",
        "module": "insightspike.interfaces",
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Base agent interface for question-answering systems.",
        "full_name": "insightspike.interfaces.IAgent",
        "tags": []
      },
      {
        "name": "IDataStore",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Full datastore interface with search capabilities.",
        "full_name": "insightspike.interfaces.IDataStore",
        "tags": []
      },
      {
        "name": "IEmbedder",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for text embedders.",
        "full_name": "insightspike.interfaces.IEmbedder",
        "tags": []
      },
      {
        "name": "IEpisodeStore",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for episode storage.",
        "full_name": "insightspike.interfaces.IEpisodeStore",
        "tags": []
      },
      {
        "name": "IGraphAnalyzer",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for graph analysis and metrics.",
        "full_name": "insightspike.interfaces.IGraphAnalyzer",
        "tags": []
      },
      {
        "name": "IGraphBuilder",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for building PyTorch Geometric graphs.",
        "full_name": "insightspike.interfaces.IGraphBuilder",
        "tags": []
      },
      {
        "name": "ILLMProvider",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for LLM providers.",
        "full_name": "insightspike.interfaces.ILLMProvider",
        "tags": []
      },
      {
        "name": "IMemoryAgent",
        ...
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Agent with memory management capabilities.",
        "full_name": "insightspike.interfaces.IMemoryAgent",
        "tags": []
      },
      {
        "name": "IMemoryManager",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for memory management.",
        "full_name": "insightspike.interfaces.IMemoryManager",
        "tags": []
      },
      {
        "name": "IMemorySearch",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for advanced memory search with graph support.",
        "full_name": "insightspike.interfaces.IMemorySearch",
        "tags": []
      },
      {
        "name": "CycleResult",
        "module": "insightspike.interfaces.agent",
        "type": "class",
        "signature": "(response: str, reasoning_trace: str, memory_used: List[Dict[str, Any]], spike_detected: bool, graph_metrics: Dict[str, float], reasoning_quality: float, convergence_score: float, has_spike: bool) -> None",
        "docstring": "Result from a single reasoning cycle.",
        "full_name": "insightspike.interfaces.agent.CycleResult",
        "tags": []
      },
      {
        "name": "IAgent",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Base agent interface for question-answering systems.",
        "full_name": "insightspike.interfaces.agent.IAgent",
        "tags": []
      },
      {
        "name": "IMemoryAgent",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Agent with memory management capabilities.",
        "full_name": "insightspike.interfaces.agent.IMemoryAgent",
        "tags": []
      },
      {
        "name": "Episode",
        "module": "insightspike.interfaces.datastore",
        "type": "class",
        "signature": "(text: str, vec: numpy.ndarray, c: float = 0.5, timestamp: float = <factory>, metadata: Dict[str, Any] = <factory>, episode_type: str = 'experience', selection_count: int = 0, creation_time: float = <factory>, confidence: Optional[float] = None) -> None",
        "docstring": "Single memory entry with vector embedding, text, and C-value.",
        "full_name": "insightspike.interfaces.datastore.Episode",
        "tags": []
      },
      {
        "name": "IDataStore",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Full datastore interface with search capabilities.",
        "full_name": "insightspike.interfaces.datastore.IDataStore",
        "tags": []
      },
      {
        "name": "IEpisodeStore",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for episode storage.",
        "full_name": "insightspike.interfaces.datastore.IEpisodeStore",
        "tags": []
      },
      {
        "name": "IEmbedder",
        "module": "insightspike.interfaces.embedder",
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for text embedders.",
        "full_name": "insightspike.interfaces.embedder.IEmbedder",
        "tags": []
      },
      {
        "name": "Episode",
        "module": "insightspike.interfaces.graph",
        "type": "class",
        "signature": "(text: str, vec: numpy.ndarray, c: float = 0.5, timestamp: float = <factory>, metadata: Dict[str, Any] = <factory>, episode_type: str = 'experience', selection_count: int = 0, creation_time: float = <factory>, confidence: Optional[float] = None) -> None",
        "docstring": "Single memory entry with vector embedding, text, and C-value.",
        "full_name": "insightspike.interfaces.graph.Episode",
        "tags": []
      },
      {
        "name": "IGraphAnalyzer",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for graph analysis and metrics.",
        "full_name": "insightspike.interfaces.graph.IGraphAnalyzer",
        "tags": []
      },
      {
        "name": "IGraphBuilder",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for building PyTorch Geometric graphs.",
        "full_name": "insightspike.interfaces.graph.IGraphBuilder",
        "tags": []
      },
      {
        "name": "ILLMProvider",
        "module": "insightspike.interfaces.llm",
        "type": "class",
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for LLM providers.",
        "full_name": "insightspike.interfaces.llm.ILLMProvider",
        "tags": []
      },
      {
        "name": "Episode",
        "module": "insightspike.interfaces.memory",
        "type": "class",
        "signature": "(text: str, vec: numpy.ndarray, c: float = 0.5, timestamp: float = <factory>, metadata: Dict[str, Any] = <factory>, episode_type: str = 'experience', selection_count: int = 0, creation_time: float = <factory>, confidence: Optional[float] = None) -> None",
        "docstring": "Single memory entry with vector embedding, text, and C-value.",
        "full_name": "insightspike.interfaces.memory.Episode",
        "tags": []
      },
      {
        "name": "IMemoryManager",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for memory management.",
        "full_name": "insightspike.interfaces.memory.IMemoryManager",
        "tags": []
      },
      {
        "name": "IMemorySearch",
        ...
        "signature": "(*args, **kwargs)",
        "docstring": "Interface for advanced memory search with graph support.",
        "full_name": "insightspike.interfaces.memory.IMemorySearch",
        "tags": []
      },
      {
        "name": "PatternLogger",
      ...
      },
      {
        ...
        "signature": "(node_cost: float = 1.0, edge_cost: float = 1.0, optimization_level: Union[str, insightspike.algorithms.graph_edit_distance.OptimizationLevel] = <OptimizationLevel.STANDARD: 'standard'>, timeout_seconds: float = 5.0, max_graph_size_exact: int = 50)",
        "docstring": "Graph Edit Distance calculator for PyTorch Geometric graphs.",
        "full_name": "insightspike.metrics.graph_metrics.GraphEditDistance",
        "tags": []
      },
      {
        "name": "InformationGain",
        ...
        "signature": "(method: Union[str, insightspike.algorithms.information_gain.EntropyMethod] = <EntropyMethod.CLUSTERING: 'clustering'>, k_clusters: int = 8, min_samples: int = 2, random_state: int = 42)",
        "docstring": "Information Gain calculator for measuring learning progress.",
        "full_name": "insightspike.metrics.graph_metrics.InformationGain",
        "tags": []
      },
      {
        "name": "delta_ged",
      ...
      },
      {
        ...
        "signature": "() -> insightspike.algorithms.graph_edit_distance.GraphEditDistance",
        "docstring": "Get or create global GED calculator instance.",
        "full_name": "insightspike.metrics.graph_metrics.get_global_ged_calculator",
        "tags": []
      },
      {
        "name": "GEDIGMetrics",
      ...
      },
      {
        ...
        "signature": "(calculator: Optional[insightspike.algorithms.graph_importance.GraphImportanceCalculator] = None)",
        "docstring": "Track and update importance scores dynamically as the graph evolves.",
        "full_name": "insightspike.utils.DynamicImportanceTracker",
        "tags": []
      },
      {
        "name": "GraphImportanceCalculator",
        ...
        "signature": "(decay_factor: float = 0.1, alpha: float = 0.85, epsilon: float = 1e-06, max_iterations: int = 100)",
        "docstring": "Calculate node importance using various graph centrality measures.",
        "full_name": "insightspike.utils.GraphImportanceCalculator",
        "tags": []
      },
      {
  ...
  "scripts": {
    "scripts": [
      ...
      "hello_insight.py",
      "playground.py",
      "public_quick_start.py",
      "simulate_econophysics.py",
      "simulate_eureka.py",
      "test_analogy_spike.py",
      "test_local_llm.py"
    ],
    "count": 32,
    "info": [
